...
KeystoreItems::KeystoreItems(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value KeystoreItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeystoreItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeystoreItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeystoreItems::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_FormatIsSet) {
            object["format"] = JsonValueConverter<std::string>::toJsonValue(getFormat());
        }
        if (m_ChainIsSet) {
            object["chain"] = JsonValueConverter<std::vector<std::shared_ptr<KeystoreChainItems>>>::toJsonValue(getChain());
        }
    return object;
}

void KeystoreItems::fromJsonObject_internal(boost::json::object const& object)
{
    m_AliasIsSet = false;
    ...
    }
    {
        ...
        if (FormatIt != object.end()) {
            setFormat(JsonValueConverter<std::string>::fromJsonValue(FormatIt->value()));
        }
    }
    {
        const auto ChainIt = object.find("chain");
        if (ChainIt != object.end()) {
            setChain(JsonValueConverter<std::vector<std::shared_ptr<KeystoreChainItems>>>::fromJsonValue(ChainIt->value()));
        }
    }
}
...
void KeystoreItems::setChain(std::vector<std::shared_ptr<KeystoreChainItems>> value)
{
    ...
    m_Chain = std::move(value);
    m_ChainIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<KeystoreItems>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeystoreItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeystoreItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeystoreItems>>>::fromJsonValue(boost::json::parse(json));
}
