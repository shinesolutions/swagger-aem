...
SamlConfigurationPropertyItemsArray::SamlConfigurationPropertyItemsArray(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string SamlConfigurationPropertyItemsArray::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value SamlConfigurationPropertyItemsArray::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SamlConfigurationPropertyItemsArray::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SamlConfigurationPropertyItemsArray");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SamlConfigurationPropertyItemsArray::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_ValuesIsSet) {
            object["values"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getValues());
        }
...
void SamlConfigurationPropertyItemsArray::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    ...
    }
    {
        ...
        if (ValuesIt != object.end()) {
            setValues(JsonValueConverter<std::vector<std::string>>::fromJsonValue(ValuesIt->value()));
        }
    }
    {
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<SamlConfigurationPropertyItemsArray>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SamlConfigurationPropertyItemsArray>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<SamlConfigurationPropertyItemsArray>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SamlConfigurationPropertyItemsArray>>>::fromJsonValue(boost::json::parse(json));
}
