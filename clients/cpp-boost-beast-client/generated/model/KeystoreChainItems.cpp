...
KeystoreChainItems::KeystoreChainItems(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string KeystoreChainItems::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value KeystoreChainItems::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeystoreChainItems::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeystoreChainItems");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeystoreChainItems::toJsonObject_internal() const
{
...
void KeystoreChainItems::fromJsonObject_internal(boost::json::object const& object)
{
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeystoreChainItems>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeystoreChainItems>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeystoreChainItems>>>::fromJsonValue(boost::json::parse(json));
}
