...
KeystoreInfo::KeystoreInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}

std::string KeystoreInfo::toJsonString(bool prettyJson /* = false */) const
{
...
boost::json::value KeystoreInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void KeystoreInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for KeystoreInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object KeystoreInfo::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_AliasesIsSet) {
            object["aliases"] = JsonValueConverter<std::vector<std::shared_ptr<KeystoreItems>>>::toJsonValue(getAliases());
        }
        if (m_ExistsIsSet) {
            object["exists"] = JsonValueConverter<bool>::toJsonValue(isExists());
        }
    return object;
}

void KeystoreInfo::fromJsonObject_internal(boost::json::object const& object)
{
    m_AliasesIsSet = false;
    m_ExistsIsSet = false;
    {
        const auto AliasesIt = object.find("aliases");
        if (AliasesIt != object.end()) {
            setAliases(JsonValueConverter<std::vector<std::shared_ptr<KeystoreItems>>>::fromJsonValue(AliasesIt->value()));
        }
    }
    {
        const auto ExistsIt = object.find("exists");
        if (ExistsIt != object.end()) {
            setExists(JsonValueConverter<bool>::fromJsonValue(ExistsIt->value()));
        }
    }
}
...
void KeystoreInfo::setExists(bool value)
{
    ...
    m_Exists = std::move(value);
    m_ExistsIsSet = true;
}

std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<KeystoreInfo>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<KeystoreInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<KeystoreInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<KeystoreInfo>>>::fromJsonValue(boost::json::parse(json));
}
