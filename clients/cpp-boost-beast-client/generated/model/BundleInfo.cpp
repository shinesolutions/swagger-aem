...
BundleInfo::BundleInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value BundleInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void BundleInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for BundleInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object BundleInfo::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_sIsSet) {
            object["s"] = JsonValueConverter<std::vector<int32_t>>::toJsonValue(getS());
        }
        if (m_DataIsSet) {
            object["data"] = JsonValueConverter<std::vector<std::shared_ptr<BundleData>>>::toJsonValue(getData());
        }
    return object;
}

void BundleInfo::fromJsonObject_internal(boost::json::object const& object)
{
    m_StatusIsSet = false;
    m_sIsSet = false;
    m_DataIsSet = false;
    ...
    {
        const auto sIt = object.find("s");
        if (sIt != object.end()) {
            setS(JsonValueConverter<std::vector<int32_t>>::fromJsonValue(sIt->value()));
        }
    }
    {
        const auto DataIt = object.find("data");
        if (DataIt != object.end()) {
            setData(JsonValueConverter<std::vector<std::shared_ptr<BundleData>>>::fromJsonValue(DataIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<BundleInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<BundleInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<BundleInfo>>>::fromJsonValue(boost::json::parse(json));
}
