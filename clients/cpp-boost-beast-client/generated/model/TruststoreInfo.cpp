...
TruststoreInfo::TruststoreInfo(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value TruststoreInfo::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void TruststoreInfo::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for TruststoreInfo");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object TruststoreInfo::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_AliasesIsSet) {
            object["aliases"] = JsonValueConverter<std::vector<std::shared_ptr<TruststoreItems>>>::toJsonValue(getAliases());
        }
        if (m_ExistsIsSet) {
...
void TruststoreInfo::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    m_ExistsIsSet = false;
    {
        ...
        if (AliasesIt != object.end()) {
            setAliases(JsonValueConverter<std::vector<std::shared_ptr<TruststoreItems>>>::fromJsonValue(AliasesIt->value()));
        }
    }
    {
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<TruststoreInfo>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<TruststoreInfo>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<TruststoreInfo>>>::fromJsonValue(boost::json::parse(json));
}
