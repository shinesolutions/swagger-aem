...
SamlConfigurationPropertyItemsString::SamlConfigurationPropertyItemsString(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value SamlConfigurationPropertyItemsString::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void SamlConfigurationPropertyItemsString::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for SamlConfigurationPropertyItemsString");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object SamlConfigurationPropertyItemsString::toJsonObject_internal() const
{
...
void SamlConfigurationPropertyItemsString::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<SamlConfigurationPropertyItemsString>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<SamlConfigurationPropertyItemsString>>>::fromJsonValue(boost::json::parse(json));
}
