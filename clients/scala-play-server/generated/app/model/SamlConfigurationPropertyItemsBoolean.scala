...
/**
  * Represents the Swagger definition for SamlConfigurationPropertyItemsBoolean.
...
object SamlConfigurationPropertyItemsBoolean {
  implicit lazy val samlConfigurationPropertyItemsBooleanJsonFormat: Format[SamlConfigurationPropertyItemsBoolean] = Json.format[SamlConfigurationPropertyItemsBoolean]
}
