...
object CqApi {
  ...
  def getLoginPage(host: String): Task[String] = {
  ...
  def postCqActions(host: String, authorizableId: String, changelog: String)(implicit authorizableIdQuery: QueryParam[String], changelogQuery: QueryParam[String]): Task[Unit] = {
    ...
    val queryParams = Query(
      ("authorizableId", Some(authorizableIdQuery.toParamString(authorizableId))), ("changelog", Some(changelogQuery.toParamString(changelog))))
