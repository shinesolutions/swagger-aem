	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	itemAtq = stringify(&jcrContentSlashaliasUpdate, "bool");
	queryParams.insert(pair<string, string>("jcr:content/aliasUpdate", itemAtq));
	if( itemAtq.empty()==true){
		queryParams.erase("jcr:content/aliasUpdate");
	}
	...
	void(* handler)(Error, void* ) , void* userData, bool isAsync)
{
	...
	string url("/libs/replication/treeactivation.html");
	int pos;
	...
	void(* handler)(Error, void* ) , void* userData)
{
	...
	ignoredeactivated, onlymodified, path, cmd, 
	handler, userData, true);
}
