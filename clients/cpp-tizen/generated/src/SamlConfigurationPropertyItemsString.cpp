...
void
SamlConfigurationPropertyItemsString::__init()
{
	//name = std::string();
	//optional = bool(false);
	//is_set = bool(false);
...
void
SamlConfigurationPropertyItemsString::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
SamlConfigurationPropertyItemsString::fromJson(char* jsonStr)
{
...
SamlConfigurationPropertyItemsString::SamlConfigurationPropertyItemsString(char* json)
{
	this->fromJson(json);
}
...
bool
SamlConfigurationPropertyItemsString::getOptional()
{
	return optional;
}
...
bool
SamlConfigurationPropertyItemsString::getIsSet()
{
	return is_set;
}
