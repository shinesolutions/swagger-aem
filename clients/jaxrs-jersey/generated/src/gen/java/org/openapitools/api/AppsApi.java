...
public class AppsApi  {
   ...
   public AppsApi(@Context ServletConfig servletContext) {
      AppsApiService delegate = null;
      ...
      if (delegate == null) {
         delegate = AppsApiServiceFactory.getAppsApi();
      }
    ...
    public Response postConfigApacheSlingDavExServlet(@ApiParam(value = "") @QueryParam("alias")  String alias,@ApiParam(value = "") @QueryParam("alias@TypeHint")  String aliasAtTypeHint,@ApiParam(value = "") @QueryParam("dav.create-absolute-uri")  Boolean davCreateAbsoluteUri,@ApiParam(value = "") @QueryParam("dav.create-absolute-uri@TypeHint")  String davCreateAbsoluteUriAtTypeHint,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response postConfigApacheSlingReferrerFilter(@ApiParam(value = "") @QueryParam("allow.empty")  Boolean allowEmpty,@ApiParam(value = "") @QueryParam("allow.empty@TypeHint")  String allowEmptyAtTypeHint,@ApiParam(value = "") @QueryParam("allow.hosts")  String allowHosts,@ApiParam(value = "") @QueryParam("allow.hosts@TypeHint")  String allowHostsAtTypeHint,@ApiParam(value = "") @QueryParam("allow.hosts.regexp")  String allowHostsRegexp,@ApiParam(value = "") @QueryParam("allow.hosts.regexp@TypeHint")  String allowHostsRegexpAtTypeHint,@ApiParam(value = "") @QueryParam("filter.methods")  String filterMethods,@ApiParam(value = "") @QueryParam("filter.methods@TypeHint")  String filterMethodsAtTypeHint,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response postConfigProperty(@ApiParam(value = "", required = true) @PathParam("configNodeName") @NotNull  String configNodeName,@Context SecurityContext securityContext)
    throws NotFoundException {
