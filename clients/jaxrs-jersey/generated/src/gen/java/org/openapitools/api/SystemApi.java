...
public class SystemApi  {
   ...
   public SystemApi(@Context ServletConfig servletContext) {
      SystemApiService delegate = null;
      ...
      if (delegate == null) {
         delegate = SystemApiServiceFactory.getSystemApi();
      }
    ...
    public Response getAemHealthCheck(@ApiParam(value = "") @QueryParam("tags")  String tags,@ApiParam(value = "") @QueryParam("combineTagsOr")  Boolean combineTagsOr,@Context SecurityContext securityContext)
    ...
    public Response getBundleInfo(@ApiParam(value = "", required = true) @PathParam("name") @NotNull  String name,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response postBundle(@ApiParam(value = "", required = true) @PathParam("name") @NotNull  String name,@ApiParam(value = "", required = true) @QueryParam("action") @NotNull  String action,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response postJmxRepository(@ApiParam(value = "", required = true) @PathParam("action") @NotNull  String action,@Context SecurityContext securityContext)
    throws NotFoundException {
