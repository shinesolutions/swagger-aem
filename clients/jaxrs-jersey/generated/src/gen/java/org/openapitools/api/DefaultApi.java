...
public class DefaultApi  {
 ...
 @FormDataParam("keyStore") FormDataBodyPart keyStoreBodypart ,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.postAuthorizableKeystore(intermediatePath, authorizableId, operation, currentPassword, newPassword, rePassword, keyPassword, keyStorePass, alias, newAlias, removeAlias, certChainBodypart, pkBodypart, keyStoreBodypart, securityContext);
    }
    @javax.ws.rs.POST
    @Path("/{path}/{name}")
    @Consumes({ "multipart/form-data" })
    ...
    public Response postNode(@ApiParam(value = "", required = true) @PathParam("path") @NotNull  String path,@ApiParam(value = "", required = true) @PathParam("name") @NotNull  String name,@ApiParam(value = "") @QueryParam(":operation")  String operation,@ApiParam(value = "") @QueryParam("deleteAuthorizable")  String deleteAuthorizable,
 @FormDataParam("file") FormDataBodyPart _fileBodypart ,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.postNode(path, name, operation, deleteAuthorizable, _fileBodypart, securityContext);
    }
    @javax.ws.rs.POST
    ...
    public Response postPath(@ApiParam(value = "", required = true) @PathParam("path") @NotNull  String path,@ApiParam(value = "", required = true) @QueryParam("jcr:primaryType") @NotNull  String jcrPrimaryType,@ApiParam(value = "", required = true) @QueryParam(":name") @NotNull  String name,@Context SecurityContext securityContext)
    throws NotFoundException {
