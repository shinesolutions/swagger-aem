...
public class SamlConfigurationPropertyItemsString {
  ...
  public SamlConfigurationPropertyItemsString name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public SamlConfigurationPropertyItemsString optional(@Nullable Boolean optional) {
  ...
  public SamlConfigurationPropertyItemsString isSet(@Nullable Boolean isSet) {
    this.isSet = isSet;
    return this;
  }
  ...
  public SamlConfigurationPropertyItemsString type(@Nullable Integer type) {
    this.type = type;
    return this;
  }
  ...
  public SamlConfigurationPropertyItemsString value(@Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public SamlConfigurationPropertyItemsString description(@Nullable String description) {
