...
# **delete_agent**
> `delete_agent`(_api::`SlingApi`, `runmode`::`String`, `name`::`String`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_agent`(_api::`SlingApi`, response_stream::`Channel`, `runmode`::`String`, `name`::`String`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **delete_node**
> `delete_node`(_api::`SlingApi`, `path`::`String`, `name`::`String`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `delete_node`(_api::`SlingApi`, response_stream::`Channel`, `path`::`String`, `name`::`String`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_agent**
> `get_agent`(_api::`SlingApi`, `runmode`::`String`, `name`::`String`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_agent`(_api::`SlingApi`, response_stream::`Channel`, `runmode`::`String`, `name`::`String`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_agents**
> `get_agents`(_api::`SlingApi`, `runmode`::`String`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_agents`(_api::`SlingApi`, response_stream::`Channel`, `runmode`::`String`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
> `get_authorizable_keystore`(_api::`SlingApi`, `intermediate_path`::`String`, `authorizable_id`::`String`; _mediaType=nothing) -> `KeystoreInfo`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_authorizable_keystore`(_api::`SlingApi`, response_stream::`Channel`, `intermediate_path`::`String`, `authorizable_id`::`String`; _mediaType=nothing) -> `Channel`{ `KeystoreInfo` }, `OpenAPI.Clients.ApiResponse`
...
# **get_keystore**
> `get_keystore`(_api::`SlingApi`, `intermediate_path`::`String`, `authorizable_id`::`String`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_keystore`(_api::`SlingApi`, response_stream::`Channel`, `intermediate_path`::`String`, `authorizable_id`::`String`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
# **get_node**
> `get_node`(_api::`SlingApi`, `path`::`String`, `name`::`String`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_node`(_api::`SlingApi`, response_stream::`Channel`, `path`::`String`, `name`::`String`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **get_package**
> `get_package`(_api::`SlingApi`, `group`::`String`, `name`::`String`, `version`::`String`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_package`(_api::`SlingApi`, response_stream::`Channel`, `group`::`String`, `name`::`String`, `version`::`String`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
# **get_package_filter**
> `get_package_filter`(_api::`SlingApi`, `group`::`String`, `name`::`String`, `version`::`String`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_package_filter`(_api::`SlingApi`, response_stream::`Channel`, `group`::`String`, `name`::`String`, `version`::`String`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
# **get_query**
> `get_query`(_api::`SlingApi`, `path`::`String`, `p_limit`::`Float64`, `1_property`::`String`, `1_property_value`::`String`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_query`(_api::`SlingApi`, response_stream::`Channel`, `path`::`String`, `p_limit`::`Float64`, `1_property`::`String`, `1_property_value`::`String`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
# **get_truststore**
> `get_truststore`(_api::`SlingApi`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_truststore`(_api::`SlingApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
# **get_truststore_info**
> `get_truststore_info`(_api::`SlingApi`; _mediaType=nothing) -> `TruststoreInfo`, `OpenAPI.Clients.ApiResponse` <br/>
> `get_truststore_info`(_api::`SlingApi`, response_stream::`Channel`; _mediaType=nothing) -> `Channel`{ `TruststoreInfo` }, `OpenAPI.Clients.ApiResponse`
...
> `post_authorizable_keystore`(_api::`SlingApi`, `intermediate_path`::`String`, `authorizable_id`::`String`; `operation`=nothing, `current_password`=nothing, `new_password`=nothing, `re_password`=nothing, `key_password`=nothing, `key_store_pass`=nothing, `alias`=nothing, `new_alias`=nothing, `remove_alias`=nothing, `cert_chain`=nothing, `pk`=nothing, `key_store`=nothing, _mediaType=nothing) -> `KeystoreInfo`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_authorizable_keystore`(_api::`SlingApi`, response_stream::`Channel`, `intermediate_path`::`String`, `authorizable_id`::`String`; `operation`=nothing, `current_password`=nothing, `new_password`=nothing, `re_password`=nothing, `key_password`=nothing, `key_store_pass`=nothing, `alias`=nothing, `new_alias`=nothing, `remove_alias`=nothing, `cert_chain`=nothing, `pk`=nothing, `key_store`=nothing, _mediaType=nothing) -> `Channel`{ `KeystoreInfo` }, `OpenAPI.Clients.ApiResponse`
...
# **post_authorizables**
> `post_authorizables`(_api::`SlingApi`, `authorizable_id`::`String`, `intermediate_path`::`String`; `create_user`=nothing, `create_group`=nothing, `reppassword`=nothing, `profile_given_name`=nothing, _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_authorizables`(_api::`SlingApi`, response_stream::`Channel`, `authorizable_id`::`String`, `intermediate_path`::`String`; `create_user`=nothing, `create_group`=nothing, `reppassword`=nothing, `profile_given_name`=nothing, _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
> `post_config_apache_sling_dav_ex_servlet`(_api::`SlingApi`; `alias`=nothing, `alias_type_hint`=nothing, `dav_create_absolute_uri`=nothing, `dav_create_absolute_uri_type_hint`=nothing, _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_config_apache_sling_dav_ex_servlet`(_api::`SlingApi`, response_stream::`Channel`; `alias`=nothing, `alias_type_hint`=nothing, `dav_create_absolute_uri`=nothing, `dav_create_absolute_uri_type_hint`=nothing, _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_config_apache_sling_get_servlet`(_api::`SlingApi`; `json_maximumresults`=nothing, `json_maximumresults_type_hint`=nothing, `enable_html`=nothing, `enable_html_type_hint`=nothing, `enable_txt`=nothing, `enable_txt_type_hint`=nothing, `enable_xml`=nothing, `enable_xml_type_hint`=nothing, _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_config_apache_sling_get_servlet`(_api::`SlingApi`, response_stream::`Channel`; `json_maximumresults`=nothing, `json_maximumresults_type_hint`=nothing, `enable_html`=nothing, `enable_html_type_hint`=nothing, `enable_txt`=nothing, `enable_txt_type_hint`=nothing, `enable_xml`=nothing, `enable_xml_type_hint`=nothing, _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_config_apache_sling_referrer_filter`(_api::`SlingApi`; `allow_empty`=nothing, `allow_empty_type_hint`=nothing, `allow_hosts`=nothing, `allow_hosts_type_hint`=nothing, `allow_hosts_regexp`=nothing, `allow_hosts_regexp_type_hint`=nothing, `filter_methods`=nothing, `filter_methods_type_hint`=nothing, _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_config_apache_sling_referrer_filter`(_api::`SlingApi`, response_stream::`Channel`; `allow_empty`=nothing, `allow_empty_type_hint`=nothing, `allow_hosts`=nothing, `allow_hosts_type_hint`=nothing, `allow_hosts_regexp`=nothing, `allow_hosts_regexp_type_hint`=nothing, `filter_methods`=nothing, `filter_methods_type_hint`=nothing, _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
> `post_config_property`(_api::`SlingApi`, `config_node_name`::`String`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_config_property`(_api::`SlingApi`, response_stream::`Channel`, `config_node_name`::`String`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **post_node**
> `post_node`(_api::`SlingApi`, `path`::`String`, `name`::`String`; `operation`=nothing, `delete_authorizable`=nothing, `file`=nothing, _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_node`(_api::`SlingApi`, response_stream::`Channel`, `path`::`String`, `name`::`String`; `operation`=nothing, `delete_authorizable`=nothing, `file`=nothing, _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **post_node_rw**
> `post_node_rw`(_api::`SlingApi`, `path`::`String`, `name`::`String`; `add_members`=nothing, _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_node_rw`(_api::`SlingApi`, response_stream::`Channel`, `path`::`String`, `name`::`String`; `add_members`=nothing, _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **post_path**
> `post_path`(_api::`SlingApi`, `path`::`String`, `jcrprimary_type`::`String`, `name`::`String`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_path`(_api::`SlingApi`, response_stream::`Channel`, `path`::`String`, `jcrprimary_type`::`String`, `name`::`String`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **post_query**
> `post_query`(_api::`SlingApi`, `path`::`String`, `p_limit`::`Float64`, `1_property`::`String`, `1_property_value`::`String`; _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_query`(_api::`SlingApi`, response_stream::`Channel`, `path`::`String`, `p_limit`::`Float64`, `1_property`::`String`, `1_property_value`::`String`; _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
> `post_tree_activation`(_api::`SlingApi`, `ignoredeactivated`::`Bool`, `onlymodified`::`Bool`, `path`::`String`, `cmd`::`String`; _mediaType=nothing) -> `Nothing`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_tree_activation`(_api::`SlingApi`, response_stream::`Channel`, `ignoredeactivated`::`Bool`, `onlymodified`::`Bool`, `path`::`String`, `cmd`::`String`; _mediaType=nothing) -> `Channel`{ `Nothing` }, `OpenAPI.Clients.ApiResponse`
...
# **post_truststore**
> `post_truststore`(_api::`SlingApi`; `operation`=nothing, `new_password`=nothing, `re_password`=nothing, `key_store_type`=nothing, `remove_alias`=nothing, `certificate`=nothing, _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_truststore`(_api::`SlingApi`, response_stream::`Channel`; `operation`=nothing, `new_password`=nothing, `re_password`=nothing, `key_store_type`=nothing, `remove_alias`=nothing, `certificate`=nothing, _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
...
> `post_truststore_p_k_c_s12`(_api::`SlingApi`; `truststore_p12`=nothing, _mediaType=nothing) -> `String`, `OpenAPI.Clients.ApiResponse` <br/>
> `post_truststore_p_k_c_s12`(_api::`SlingApi`, response_stream::`Channel`; `truststore_p12`=nothing, _mediaType=nothing) -> `Channel`{ `String` }, `OpenAPI.Clients.ApiResponse`
