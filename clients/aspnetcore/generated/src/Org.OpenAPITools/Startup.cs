        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("3.7.1-pre.0", new OpenApiInfo
                    {
                        Title = "Adobe Experience Manager (AEM) API",
                        Description = "Adobe Experience Manager (AEM) API (ASP.NET Core 8.0)",
                        TermsOfService = new Uri("https://github.com/openapitools/openapi-generator"),
                        Contact = new OpenApiContact
                        {
                            Name = "Shine Solutions",
                            Url = new Uri("https://github.com/shinesolutions"),
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/3.7.1-pre.0/openapi.json", "Adobe Experience Manager (AEM) API");
