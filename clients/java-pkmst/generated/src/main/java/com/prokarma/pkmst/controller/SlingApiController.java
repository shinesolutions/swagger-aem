...
@Autowired
    ...
    public ResponseEntity<Void> postAgent(@ApiParam(value = "",required=true ) @PathVariable("runmode") String runmode,
        @ApiParam(value = "",required=true ) @PathVariable("name") String name,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/cq:distribute", required = false) Boolean jcrContentCqDistribute,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/cq:distribute@TypeHint", required = false) String jcrContentCqDistributeAtTypeHint,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/cq:name", required = false) String jcrContentCqName,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/cq:template", required = false) String jcrContentCqTemplate,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/aliasUpdate", required = false) Boolean jcrContentAliasUpdate,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/enabled", required = false) Boolean jcrContentEnabled,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/jcr:description", required = false) String jcrContentJcrDescription,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/jcr:lastModified", required = false) String jcrContentJcrLastModified,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/jcr:lastModifiedBy", required = false) String jcrContentJcrLastModifiedBy,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/jcr:mixinTypes", required = false) String jcrContentJcrMixinTypes,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/jcr:title", required = false) String jcrContentJcrTitle,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/logLevel", required = false) String jcrContentLogLevel,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/noStatusUpdate", required = false) Boolean jcrContentNoStatusUpdate,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/noVersioning", required = false) Boolean jcrContentNoVersioning,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolConnectTimeout", required = false) BigDecimal jcrContentProtocolConnectTimeout,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolHTTPConnectionClosed", required = false) Boolean jcrContentProtocolHTTPConnectionClosed,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolHTTPExpired", required = false) String jcrContentProtocolHTTPExpired,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolHTTPHeaders", required = false) List<String> jcrContentProtocolHTTPHeaders,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolHTTPHeaders@TypeHint", required = false) String jcrContentProtocolHTTPHeadersAtTypeHint,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolHTTPMethod", required = false) String jcrContentProtocolHTTPMethod,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolHTTPSRelaxed", required = false) Boolean jcrContentProtocolHTTPSRelaxed,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolInterface", required = false) String jcrContentProtocolInterface,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolSocketTimeout", required = false) BigDecimal jcrContentProtocolSocketTimeout,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/protocolVersion", required = false) String jcrContentProtocolVersion,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/proxyNTLMDomain", required = false) String jcrContentProxyNTLMDomain,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/proxyNTLMHost", required = false) String jcrContentProxyNTLMHost,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/proxyHost", required = false) String jcrContentProxyHost,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/proxyPassword", required = false) String jcrContentProxyPassword,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/proxyPort", required = false) BigDecimal jcrContentProxyPort,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/proxyUser", required = false) String jcrContentProxyUser,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/queueBatchMaxSize", required = false) BigDecimal jcrContentQueueBatchMaxSize,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/queueBatchMode", required = false) String jcrContentQueueBatchMode,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/queueBatchWaitTime", required = false) BigDecimal jcrContentQueueBatchWaitTime,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/retryDelay", required = false) String jcrContentRetryDelay,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/reverseReplication", required = false) Boolean jcrContentReverseReplication,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/serializationType", required = false) String jcrContentSerializationType,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/sling:resourceType", required = false) String jcrContentSlingResourceType,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/ssl", required = false) String jcrContentSsl,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/transportNTLMDomain", required = false) String jcrContentTransportNTLMDomain,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/transportNTLMHost", required = false) String jcrContentTransportNTLMHost,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/transportPassword", required = false) String jcrContentTransportPassword,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/transportUri", required = false) String jcrContentTransportUri,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/transportUser", required = false) String jcrContentTransportUser,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/triggerDistribute", required = false) Boolean jcrContentTriggerDistribute,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/triggerModified", required = false) Boolean jcrContentTriggerModified,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/triggerOnOffTime", required = false) Boolean jcrContentTriggerOnOffTime,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/triggerReceive", required = false) Boolean jcrContentTriggerReceive,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/triggerSpecific", required = false) Boolean jcrContentTriggerSpecific,
        @ApiParam(value = "")  @RequestParam(value = "jcr:content/userId", required = false) String jcrContentUserId,
        @ApiParam(value = "")  @RequestParam(value = "jcr:primaryType", required = false) String jcrPrimaryType,
    ...
    public ResponseEntity<String> postAuthorizables(@ApiParam(value = "", required = true)  @RequestParam(value = "authorizableId", required = true) String authorizableId,
        ...
        @ApiParam(value = "")  @RequestParam(value = "rep:password", required = false) String repPassword,
    ...
    public ResponseEntity<Void> postPath(@ApiParam(value = "",required=true ) @PathVariable("path") String path,
        @ApiParam(value = "", required = true)  @RequestParam(value = "jcr:primaryType", required = true) String jcrPrimaryType,
    ...
    public ResponseEntity<Void> postTreeActivation(@ApiParam(value = "", required = true)  @RequestParam(value = "ignoredeactivated", required = true) Boolean ignoredeactivated,
        ...
        @ApiParam(value = "", required = true, defaultValue = "activate")  @RequestParam(value = "cmd", required = true, defaultValue="activate") String cmd,
        @RequestHeader(value = "Accept", required = false) String accept) throws Exception {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }

    public ResponseEntity<String> postTruststore(@ApiParam(value = "")  @RequestParam(value = ":operation", required = false) String operation,
        @ApiParam(value = "")  @RequestParam(value = "newPassword", required = false) String newPassword,
        @ApiParam(value = "")  @RequestParam(value = "rePassword", required = false) String rePassword,
