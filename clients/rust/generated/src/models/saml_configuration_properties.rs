...
pub struct SamlConfigurationProperties {
    ...
    pub path: Option<Box<models::SamlConfigurationPropertyItemsArray>>,
    #[serde(rename = "service.ranking", skip_serializing_if = "Option::is_none")]
    pub service_ranking: Option<Box<models::SamlConfigurationPropertyItemsLong>>,
    #[serde(rename = "idpUrl", skip_serializing_if = "Option::is_none")]
    pub idp_url: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "idpCertAlias", skip_serializing_if = "Option::is_none")]
    pub idp_cert_alias: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "idpHttpRedirect", skip_serializing_if = "Option::is_none")]
    pub idp_http_redirect: Option<Box<models::SamlConfigurationPropertyItemsBoolean>>,
    #[serde(rename = "serviceProviderEntityId", skip_serializing_if = "Option::is_none")]
    pub service_provider_entity_id: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "assertionConsumerServiceURL", skip_serializing_if = "Option::is_none")]
    pub assertion_consumer_service_url: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "spPrivateKeyAlias", skip_serializing_if = "Option::is_none")]
    pub sp_private_key_alias: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "keyStorePassword", skip_serializing_if = "Option::is_none")]
    pub key_store_password: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "defaultRedirectUrl", skip_serializing_if = "Option::is_none")]
    pub default_redirect_url: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "userIDAttribute", skip_serializing_if = "Option::is_none")]
    pub user_id_attribute: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "useEncryption", skip_serializing_if = "Option::is_none")]
    pub use_encryption: Option<Box<models::SamlConfigurationPropertyItemsBoolean>>,
    #[serde(rename = "createUser", skip_serializing_if = "Option::is_none")]
    pub create_user: Option<Box<models::SamlConfigurationPropertyItemsBoolean>>,
    #[serde(rename = "addGroupMemberships", skip_serializing_if = "Option::is_none")]
    pub add_group_memberships: Option<Box<models::SamlConfigurationPropertyItemsBoolean>>,
    #[serde(rename = "groupMembershipAttribute", skip_serializing_if = "Option::is_none")]
    pub group_membership_attribute: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "defaultGroups", skip_serializing_if = "Option::is_none")]
    pub default_groups: Option<Box<models::SamlConfigurationPropertyItemsArray>>,
    #[serde(rename = "nameIdFormat", skip_serializing_if = "Option::is_none")]
    pub name_id_format: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "synchronizeAttributes", skip_serializing_if = "Option::is_none")]
    pub synchronize_attributes: Option<Box<models::SamlConfigurationPropertyItemsArray>>,
    #[serde(rename = "handleLogout", skip_serializing_if = "Option::is_none")]
    pub handle_logout: Option<Box<models::SamlConfigurationPropertyItemsBoolean>>,
    #[serde(rename = "logoutUrl", skip_serializing_if = "Option::is_none")]
    pub logout_url: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "clockTolerance", skip_serializing_if = "Option::is_none")]
    pub clock_tolerance: Option<Box<models::SamlConfigurationPropertyItemsLong>>,
    #[serde(rename = "digestMethod", skip_serializing_if = "Option::is_none")]
    pub digest_method: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "signatureMethod", skip_serializing_if = "Option::is_none")]
    pub signature_method: Option<Box<models::SamlConfigurationPropertyItemsString>>,
    #[serde(rename = "userIntermediatePath", skip_serializing_if = "Option::is_none")]
    pub user_intermediate_path: Option<Box<models::SamlConfigurationPropertyItemsString>>,
}
