...
impl TruststoreItems {
  ...
  pub fn with_alias(mut self, alias: String) -> TruststoreItems {
    self.alias = Some(alias);
    self
  }
  ...
  pub fn with_entry_type(mut self, entry_type: String) -> TruststoreItems {
    self.entry_type = Some(entry_type);
    self
  }
  ...
  pub fn with_subject(mut self, subject: String) -> TruststoreItems {
    self.subject = Some(subject);
    self
  }
  ...
  pub fn with_issuer(mut self, issuer: String) -> TruststoreItems {
    self.issuer = Some(issuer);
    self
  }
  ...
  pub fn with_not_before(mut self, not_before: String) -> TruststoreItems {
    self.not_before = Some(not_before);
    self
  }
  ...
  pub fn with_not_after(mut self, not_after: String) -> TruststoreItems {
    self.not_after = Some(not_after);
    self
  }
  ...
  pub fn with_serial_number(mut self, serial_number: i32) -> TruststoreItems {
    self.serial_number = Some(serial_number);
    self
  }
