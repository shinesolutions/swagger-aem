...
public interface SlingApi  {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Default response", response = String.class) })
    public String postAuthorizables(@QueryParam("authorizableId")String authorizableId, @QueryParam("intermediatePath")String intermediatePath, @QueryParam("createUser")String createUser, @QueryParam("createGroup")String createGroup, @QueryParam("rep:password")String repColonPassword, @QueryParam("profile/givenName")String profileSlashGivenName);
