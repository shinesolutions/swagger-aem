...
#ifndef TINY_CPP_CLIENT_SamlConfigurationPropertyItemsLong_H_
#define TINY_CPP_CLIENT_SamlConfigurationPropertyItemsLong_H_
...
public:
    ...
    SamlConfigurationPropertyItemsLong(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SamlConfigurationPropertyItemsLong_H_ */
