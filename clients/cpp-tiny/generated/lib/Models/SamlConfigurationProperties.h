...
#ifndef TINY_CPP_CLIENT_SamlConfigurationProperties_H_
#define TINY_CPP_CLIENT_SamlConfigurationProperties_H_
...
public:
    ...
    SamlConfigurationProperties(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SamlConfigurationProperties_H_ */
