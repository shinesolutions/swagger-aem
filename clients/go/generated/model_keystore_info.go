...
// checks if the KeystoreInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeystoreInfo{}
...
func (o KeystoreInfo) ToMap() (map[string]interface{}, error) {
