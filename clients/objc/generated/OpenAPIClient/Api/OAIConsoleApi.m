...
-(NSURLSessionTask*) getBundleInfoWithName: (NSString*) name
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/system/console/bundles/{name}.json"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"OAIBundleInfo*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIBundleInfo*)data, error);
                                }
                            }];
}
