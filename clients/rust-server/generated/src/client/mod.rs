    ...
    B::Error: Into<Box<dyn Error + Send + Sync>>,
{
    ...
    async fn post_saml_configuration<'a>(
        ...
        param_path: Option<&'a Vec<String>>,
        ...
        param_default_groups: Option<&'a Vec<String>>,
        param_name_id_format: Option<String>,
        param_synchronize_attributes: Option<&'a Vec<String>>,
        ...
        param_propertylist: Option<&'a Vec<String>>,
    ...
    async fn post_config_aem_health_check_servlet<'a>(
        &self,
        param_bundles_ignored: Option<&'a Vec<String>>,
    ...
    async fn post_config_aem_password_reset<'a>(
        &self,
        param_pwdreset_authorizables: Option<&'a Vec<String>>,
    ...
    async fn post_config_apache_http_components_proxy_configuration<'a>(
        ...
        param_proxy_exceptions: Option<&'a Vec<String>>,
    ...
    async fn post_agent<'a>(
        ...
        param_jcr_colon_content_slash_protocol_http_headers: Option<&'a Vec<String>>,
