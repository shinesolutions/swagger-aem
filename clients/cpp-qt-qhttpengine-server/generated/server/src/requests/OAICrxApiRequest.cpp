...
OAICrxApiRequest::OAICrxApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAICrxApiHandler> hdl) : QObject(s), socket(s), handler(hdl) {
...
void OAICrxApiRequest::getCrxdeStatusRequest(){
    ...
    connect(this, &OAICrxApiRequest::getCrxdeStatus, handler.data(), &OAICrxApiHandler::getCrxdeStatus);

    


    Q_EMIT getCrxdeStatus();
}


void OAICrxApiRequest::getInstallStatusRequest(){
    qDebug() << "/crx/packmgr/installstatus.jsp";
    connect(this, &OAICrxApiRequest::getInstallStatus, handler.data(), &OAICrxApiHandler::getInstallStatus);

    


    Q_EMIT getInstallStatus();
}


void OAICrxApiRequest::getPackageManagerServletRequest(){
    qDebug() << "/crx/packmgr/service/script.html";
    connect(this, &OAICrxApiRequest::getPackageManagerServlet, handler.data(), &OAICrxApiHandler::getPackageManagerServlet);

    


    Q_EMIT getPackageManagerServlet();
}


void OAICrxApiRequest::postPackageServiceRequest(){
    qDebug() << "/crx/packmgr/service.jsp";
    connect(this, &OAICrxApiRequest::postPackageService, handler.data(), &OAICrxApiHandler::postPackageService);
    ...
    Q_EMIT postPackageService(cmd);
}


void OAICrxApiRequest::postPackageServiceJsonRequest(const QString& pathstr){
    qDebug() << "/crx/packmgr/service/.json/{path}";
    connect(this, &OAICrxApiRequest::postPackageServiceJson, handler.data(), &OAICrxApiHandler::postPackageServiceJson);
    ...
    OAIHttpFileElement package;

    Q_EMIT postPackageServiceJson(path, cmd, group_name, package_name, package_version, _charset_, force, recursive, package);
}


void OAICrxApiRequest::postPackageUpdateRequest(){
    qDebug() << "/crx/packmgr/update.jsp";
    connect(this, &OAICrxApiRequest::postPackageUpdate, handler.data(), &OAICrxApiHandler::postPackageUpdate);
    ...
    Q_EMIT postPackageUpdate(group_name, package_name, version, path, filter, _charset_);
}


void OAICrxApiRequest::postSetPasswordRequest(){
    qDebug() << "/crx/explorer/ui/setpassword.jsp";
    connect(this, &OAICrxApiRequest::postSetPassword, handler.data(), &OAICrxApiHandler::postSetPassword);
    ...
    Q_EMIT postSetPassword(old, plain, verify);
}
