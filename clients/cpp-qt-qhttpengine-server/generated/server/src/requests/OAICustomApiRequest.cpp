...
OAICustomApiRequest::OAICustomApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAICustomApiHandler> hdl) : QObject(s), socket(s), handler(hdl) {
...
void OAICustomApiRequest::getAemHealthCheckRequest(){
    ...
    connect(this, &OAICustomApiRequest::getAemHealthCheck, handler.data(), &OAICustomApiHandler::getAemHealthCheck);
    ...
    Q_EMIT getAemHealthCheck(tags, combine_tags_or);
}
...
void OAICustomApiRequest::postConfigAemHealthCheckServletRequest(){
    ...
    connect(this, &OAICustomApiRequest::postConfigAemHealthCheckServlet, handler.data(), &OAICustomApiHandler::postConfigAemHealthCheckServlet);
    ...
    Q_EMIT postConfigAemHealthCheckServlet(bundles_ignored, bundles_ignored_type_hint);
}
...
void OAICustomApiRequest::postConfigAemPasswordResetRequest(){
    ...
    connect(this, &OAICustomApiRequest::postConfigAemPasswordReset, handler.data(), &OAICustomApiHandler::postConfigAemPasswordReset);
    ...
    Q_EMIT postConfigAemPasswordReset(pwdreset_authorizables, pwdreset_authorizables_type_hint);
}
