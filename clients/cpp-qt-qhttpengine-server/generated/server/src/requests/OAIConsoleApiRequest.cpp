...
OAIConsoleApiRequest::OAIConsoleApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAIConsoleApiHandler> hdl) : QObject(s), socket(s), handler(hdl) {
...
void OAIConsoleApiRequest::getAemProductInfoRequest(){
    ...
    connect(this, &OAIConsoleApiRequest::getAemProductInfo, handler.data(), &OAIConsoleApiHandler::getAemProductInfo);

    


    Q_EMIT getAemProductInfo();
}


void OAIConsoleApiRequest::getBundleInfoRequest(const QString& namestr){
    qDebug() << "/system/console/bundles/{name}.json";
    connect(this, &OAIConsoleApiRequest::getBundleInfo, handler.data(), &OAIConsoleApiHandler::getBundleInfo);
    ...
    Q_EMIT getBundleInfo(name);
}


void OAIConsoleApiRequest::getConfigMgrRequest(){
    qDebug() << "/system/console/configMgr";
    connect(this, &OAIConsoleApiRequest::getConfigMgr, handler.data(), &OAIConsoleApiHandler::getConfigMgr);
...
void OAIConsoleApiRequest::postBundleRequest(const QString& namestr){
    ...
    connect(this, &OAIConsoleApiRequest::postBundle, handler.data(), &OAIConsoleApiHandler::postBundle);
...
void OAIConsoleApiRequest::postJmxRepositoryRequest(const QString& actionstr){
    ...
    connect(this, &OAIConsoleApiRequest::postJmxRepository, handler.data(), &OAIConsoleApiHandler::postJmxRepository);
    ...
    Q_EMIT postJmxRepository(action);
}
...
void OAIConsoleApiRequest::postSamlConfigurationRequest(){
    ...
    connect(this, &OAIConsoleApiRequest::postSamlConfiguration, handler.data(), &OAIConsoleApiHandler::postSamlConfiguration);
    ...
    if(socket->queryString().keys().contains("r_delete")){
        fromStringValue(socket->queryString().value("r_delete"), r_delete);
    }
...
void OAIConsoleApiRequest::getBundleInfoResponse(const OAIBundleInfo& res){
    setSocketResponseHeaders();
...
void OAIConsoleApiRequest::getBundleInfoError(const OAIBundleInfo& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
