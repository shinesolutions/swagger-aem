...
void OAIConsoleApiHandler::getBundleInfo(QString name) {
    Q_UNUSED(name);
    auto reqObj = qobject_cast<OAIConsoleApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        OAIBundleInfo res;
        reqObj->getBundleInfoResponse(res);
    }
}
