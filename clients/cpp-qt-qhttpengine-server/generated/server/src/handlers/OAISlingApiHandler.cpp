...
void OAISlingApiHandler::getQuery(QString path, double p_limit, QString r_1_property, QString r_1_property_value) {
    Q_UNUSED(path);
    Q_UNUSED(p_limit);
    Q_UNUSED(r_1_property);
    Q_UNUSED(r_1_property_value);
    auto reqObj = qobject_cast<OAISlingApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        QString res;
...
void OAISlingApiHandler::postAgent(QString runmode, QString name, bool jcr_content_cq_distribute, QString jcr_content_cq_distribute_type_hint, QString jcr_content_cq_name, QString jcr_content_cq_template, bool jcr_content_alias_update, bool jcr_content_enabled, QString jcr_content_jcr_description, QString jcr_content_jcr_last_modified, QString jcr_content_jcr_last_modified_by, QString jcr_content_jcr_mixin_types, QString jcr_content_jcr_title, QString jcr_content_log_level, bool jcr_content_no_status_update, bool jcr_content_no_versioning, double jcr_content_protocol_connect_timeout, bool jcr_content_protocol_http_connection_closed, QString jcr_content_protocol_http_expired, QList<QString> jcr_content_protocol_http_headers, QString jcr_content_protocol_http_headers_type_hint, QString jcr_content_protocol_http_method, bool jcr_content_protocol_https_relaxed, QString jcr_content_protocol_interface, double jcr_content_protocol_socket_timeout, QString jcr_content_protocol_version, QString jcr_content_proxy_ntlm_domain, QString jcr_content_proxy_ntlm_host, QString jcr_content_proxy_host, QString jcr_content_proxy_password, double jcr_content_proxy_port, QString jcr_content_proxy_user, double jcr_content_queue_batch_max_size, QString jcr_content_queue_batch_mode, double jcr_content_queue_batch_wait_time, QString jcr_content_retry_delay, bool jcr_content_reverse_replication, QString jcr_content_serialization_type, QString jcr_content_sling_resource_type, QString jcr_content_ssl, QString jcr_content_transport_ntlm_domain, QString jcr_content_transport_ntlm_host, QString jcr_content_transport_password, QString jcr_content_transport_uri, QString jcr_content_transport_user, bool jcr_content_trigger_distribute, bool jcr_content_trigger_modified, bool jcr_content_trigger_on_off_time, bool jcr_content_trigger_receive, bool jcr_content_trigger_specific, QString jcr_content_user_id, QString jcr_primary_type, QString _operation) {
    Q_UNUSED(runmode);
    Q_UNUSED(name);
    Q_UNUSED(jcr_content_cq_distribute);
    Q_UNUSED(jcr_content_cq_distribute_type_hint);
    Q_UNUSED(jcr_content_cq_name);
    Q_UNUSED(jcr_content_cq_template);
    Q_UNUSED(jcr_content_alias_update);
    Q_UNUSED(jcr_content_enabled);
    Q_UNUSED(jcr_content_jcr_description);
    Q_UNUSED(jcr_content_jcr_last_modified);
    Q_UNUSED(jcr_content_jcr_last_modified_by);
    Q_UNUSED(jcr_content_jcr_mixin_types);
    Q_UNUSED(jcr_content_jcr_title);
    Q_UNUSED(jcr_content_log_level);
    Q_UNUSED(jcr_content_no_status_update);
    Q_UNUSED(jcr_content_no_versioning);
    Q_UNUSED(jcr_content_protocol_connect_timeout);
    Q_UNUSED(jcr_content_protocol_http_connection_closed);
    Q_UNUSED(jcr_content_protocol_http_expired);
    Q_UNUSED(jcr_content_protocol_http_headers);
    Q_UNUSED(jcr_content_protocol_http_headers_type_hint);
    Q_UNUSED(jcr_content_protocol_http_method);
    Q_UNUSED(jcr_content_protocol_https_relaxed);
    Q_UNUSED(jcr_content_protocol_interface);
    Q_UNUSED(jcr_content_protocol_socket_timeout);
    Q_UNUSED(jcr_content_protocol_version);
    Q_UNUSED(jcr_content_proxy_ntlm_domain);
    Q_UNUSED(jcr_content_proxy_ntlm_host);
    Q_UNUSED(jcr_content_proxy_host);
    Q_UNUSED(jcr_content_proxy_password);
    Q_UNUSED(jcr_content_proxy_port);
    Q_UNUSED(jcr_content_proxy_user);
    Q_UNUSED(jcr_content_queue_batch_max_size);
    Q_UNUSED(jcr_content_queue_batch_mode);
    Q_UNUSED(jcr_content_queue_batch_wait_time);
    Q_UNUSED(jcr_content_retry_delay);
    Q_UNUSED(jcr_content_reverse_replication);
    Q_UNUSED(jcr_content_serialization_type);
    Q_UNUSED(jcr_content_sling_resource_type);
    Q_UNUSED(jcr_content_ssl);
    Q_UNUSED(jcr_content_transport_ntlm_domain);
    Q_UNUSED(jcr_content_transport_ntlm_host);
    Q_UNUSED(jcr_content_transport_password);
    Q_UNUSED(jcr_content_transport_uri);
    Q_UNUSED(jcr_content_transport_user);
    Q_UNUSED(jcr_content_trigger_distribute);
    Q_UNUSED(jcr_content_trigger_modified);
    Q_UNUSED(jcr_content_trigger_on_off_time);
    Q_UNUSED(jcr_content_trigger_receive);
    Q_UNUSED(jcr_content_trigger_specific);
    Q_UNUSED(jcr_content_user_id);
    Q_UNUSED(jcr_primary_type);
    Q_UNUSED(_operation);
    auto reqObj = qobject_cast<OAISlingApiRequest*>(sender());
    if( reqObj != nullptr )
    {
...
void OAISlingApiHandler::postAuthorizables(QString authorizable_id, QString intermediate_path, QString create_user, QString create_group, QString rep_password, QString profile_given_name) {
    Q_UNUSED(authorizable_id);
    Q_UNUSED(intermediate_path);
    Q_UNUSED(create_user);
    Q_UNUSED(create_group);
    Q_UNUSED(rep_password);
    Q_UNUSED(profile_given_name);
    auto reqObj = qobject_cast<OAISlingApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        QString res;
...
void OAISlingApiHandler::postConfigProperty(QString config_node_name) {
    Q_UNUSED(config_node_name);
    auto reqObj = qobject_cast<OAISlingApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        
        reqObj->postConfigPropertyResponse();
    }
}
void OAISlingApiHandler::postNode(QString path, QString name, QString _operation, QString delete_authorizable, OAIHttpFileElement file) {
    Q_UNUSED(path);
    Q_UNUSED(name);
    Q_UNUSED(_operation);
...
void OAISlingApiHandler::postPath(QString path, QString jcr_primary_type, QString _name) {
    Q_UNUSED(path);
    Q_UNUSED(jcr_primary_type);
    Q_UNUSED(_name);
    auto reqObj = qobject_cast<OAISlingApiRequest*>(sender());
...
void OAISlingApiHandler::postQuery(QString path, double p_limit, QString r_1_property, QString r_1_property_value) {
    Q_UNUSED(path);
    Q_UNUSED(p_limit);
    Q_UNUSED(r_1_property);
    Q_UNUSED(r_1_property_value);
...
void OAISlingApiHandler::postTreeActivation(bool ignoredeactivated, bool onlymodified, QString path, QString cmd) {
...
void OAISlingApiHandler::postTruststore(QString _operation, QString new_password, QString re_password, QString key_store_type, QString remove_alias, OAIHttpFileElement certificate) {
    Q_UNUSED(_operation);
    Q_UNUSED(new_password);
    Q_UNUSED(re_password);
...
void OAISlingApiHandler::postTruststorePKCS12(OAIHttpFileElement truststore_p12) {
