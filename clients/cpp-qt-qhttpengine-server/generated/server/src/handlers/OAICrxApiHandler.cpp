...
void OAICrxApiHandler::postPackageServiceJson(QString path, QString cmd, QString group_name, QString package_name, QString package_version, QString _charset_, bool force, bool recursive, OAIHttpFileElement package) {
    Q_UNUSED(path);
    Q_UNUSED(cmd);
    Q_UNUSED(group_name);
