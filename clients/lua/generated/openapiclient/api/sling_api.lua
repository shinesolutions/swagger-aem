...
function sling_api:post_agent(runmode, name, jcr_content_cq_distribute, jcr_content_cq_distribute_type_hint, jcr_content_cq_name, jcr_content_cq_template, jcr_content_alias_update, jcr_content_enabled, jcr_content_jcr_description, jcr_content_jcr_last_modified, jcr_content_jcr_last_modified_by, jcr_content_jcr_mixin_types, jcr_content_jcr_title, jcr_content_log_level, jcr_content_no_status_update, jcr_content_no_versioning, jcr_content_protocol_connect_timeout, jcr_content_protocol_http_connection_closed, jcr_content_protocol_http_expired, jcr_content_protocol_http_headers, jcr_content_protocol_http_headers_type_hint, jcr_content_protocol_http_method, jcr_content_protocol_https_relaxed, jcr_content_protocol_interface, jcr_content_protocol_socket_timeout, jcr_content_protocol_version, jcr_content_proxy_ntlm_domain, jcr_content_proxy_ntlm_host, jcr_content_proxy_host, jcr_content_proxy_password, jcr_content_proxy_port, jcr_content_proxy_user, jcr_content_queue_batch_max_size, jcr_content_queue_batch_mode, jcr_content_queue_batch_wait_time, jcr_content_retry_delay, jcr_content_reverse_replication, jcr_content_serialization_type, jcr_content_sling_resource_type, jcr_content_ssl, jcr_content_transport_ntlm_domain, jcr_content_transport_ntlm_host, jcr_content_transport_password, jcr_content_transport_uri, jcr_content_transport_user, jcr_content_trigger_distribute, jcr_content_trigger_modified, jcr_content_trigger_on_off_time, jcr_content_trigger_receive, jcr_content_trigger_specific, jcr_content_user_id, jcr_primary_type, _operation)
	local req = http_request.new_from_uri({
		...
		host = self.host;
		port = self.port;
		path = string.format("%s/etc/replication/agents.{runmode}/%s?jcr:content/cq:distribute=%s&jcr:content/cq:distribute@TypeHint=%s&jcr:content/cq:name=%s&jcr:content/cq:template=%s&jcr:content/aliasUpdate=%s&jcr:content/enabled=%s&jcr:content/jcr:description=%s&jcr:content/jcr:lastModified=%s&jcr:content/jcr:lastModifiedBy=%s&jcr:content/jcr:mixinTypes=%s&jcr:content/jcr:title=%s&jcr:content/logLevel=%s&jcr:content/noStatusUpdate=%s&jcr:content/noVersioning=%s&jcr:content/protocolConnectTimeout=%s&jcr:content/protocolHTTPConnectionClosed=%s&jcr:content/protocolHTTPExpired=%s&jcr:content/protocolHTTPHeaders=%s&jcr:content/protocolHTTPHeaders@TypeHint=%s&jcr:content/protocolHTTPMethod=%s&jcr:content/protocolHTTPSRelaxed=%s&jcr:content/protocolInterface=%s&jcr:content/protocolSocketTimeout=%s&jcr:content/protocolVersion=%s&jcr:content/proxyNTLMDomain=%s&jcr:content/proxyNTLMHost=%s&jcr:content/proxyHost=%s&jcr:content/proxyPassword=%s&jcr:content/proxyPort=%s&jcr:content/proxyUser=%s&jcr:content/queueBatchMaxSize=%s&jcr:content/queueBatchMode=%s&jcr:content/queueBatchWaitTime=%s&jcr:content/retryDelay=%s&jcr:content/reverseReplication=%s&jcr:content/serializationType=%s&jcr:content/sling:resourceType=%s&jcr:content/ssl=%s&jcr:content/transportNTLMDomain=%s&jcr:content/transportNTLMHost=%s&jcr:content/transportPassword=%s&jcr:content/transportUri=%s&jcr:content/transportUser=%s&jcr:content/triggerDistribute=%s&jcr:content/triggerModified=%s&jcr:content/triggerOnOffTime=%s&jcr:content/triggerReceive=%s&jcr:content/triggerSpecific=%s&jcr:content/userId=%s&jcr:primaryType=%s&:operation=%s",
			self.basePath, runmode, name, http_util.encodeURIComponent(jcr_content_cq_distribute), http_util.encodeURIComponent(jcr_content_cq_distribute_type_hint), http_util.encodeURIComponent(jcr_content_cq_name), http_util.encodeURIComponent(jcr_content_cq_template), http_util.encodeURIComponent(jcr_content_alias_update), http_util.encodeURIComponent(jcr_content_enabled), http_util.encodeURIComponent(jcr_content_jcr_description), http_util.encodeURIComponent(jcr_content_jcr_last_modified), http_util.encodeURIComponent(jcr_content_jcr_last_modified_by), http_util.encodeURIComponent(jcr_content_jcr_mixin_types), http_util.encodeURIComponent(jcr_content_jcr_title), http_util.encodeURIComponent(jcr_content_log_level), http_util.encodeURIComponent(jcr_content_no_status_update), http_util.encodeURIComponent(jcr_content_no_versioning), http_util.encodeURIComponent(jcr_content_protocol_connect_timeout), http_util.encodeURIComponent(jcr_content_protocol_http_connection_closed), http_util.encodeURIComponent(jcr_content_protocol_http_expired), http_util.encodeURIComponent(jcr_content_protocol_http_headers), http_util.encodeURIComponent(jcr_content_protocol_http_headers_type_hint), http_util.encodeURIComponent(jcr_content_protocol_http_method), http_util.encodeURIComponent(jcr_content_protocol_https_relaxed), http_util.encodeURIComponent(jcr_content_protocol_interface), http_util.encodeURIComponent(jcr_content_protocol_socket_timeout), http_util.encodeURIComponent(jcr_content_protocol_version), http_util.encodeURIComponent(jcr_content_proxy_ntlm_domain), http_util.encodeURIComponent(jcr_content_proxy_ntlm_host), http_util.encodeURIComponent(jcr_content_proxy_host), http_util.encodeURIComponent(jcr_content_proxy_password), http_util.encodeURIComponent(jcr_content_proxy_port), http_util.encodeURIComponent(jcr_content_proxy_user), http_util.encodeURIComponent(jcr_content_queue_batch_max_size), http_util.encodeURIComponent(jcr_content_queue_batch_mode), http_util.encodeURIComponent(jcr_content_queue_batch_wait_time), http_util.encodeURIComponent(jcr_content_retry_delay), http_util.encodeURIComponent(jcr_content_reverse_replication), http_util.encodeURIComponent(jcr_content_serialization_type), http_util.encodeURIComponent(jcr_content_sling_resource_type), http_util.encodeURIComponent(jcr_content_ssl), http_util.encodeURIComponent(jcr_content_transport_ntlm_domain), http_util.encodeURIComponent(jcr_content_transport_ntlm_host), http_util.encodeURIComponent(jcr_content_transport_password), http_util.encodeURIComponent(jcr_content_transport_uri), http_util.encodeURIComponent(jcr_content_transport_user), http_util.encodeURIComponent(jcr_content_trigger_distribute), http_util.encodeURIComponent(jcr_content_trigger_modified), http_util.encodeURIComponent(jcr_content_trigger_on_off_time), http_util.encodeURIComponent(jcr_content_trigger_receive), http_util.encodeURIComponent(jcr_content_trigger_specific), http_util.encodeURIComponent(jcr_content_user_id), http_util.encodeURIComponent(jcr_primary_type), http_util.encodeURIComponent(_operation));
	})
...
function sling_api:post_authorizable_keystore(intermediate_path, authorizable_id, _operation, current_password, new_password, re_password, key_password, key_store_pass, alias, new_alias, remove_alias, cert_chain, pk, key_store)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/%s/{authorizableId}.ks.html?:operation=%s&currentPassword=%s&newPassword=%s&rePassword=%s&keyPassword=%s&keyStorePass=%s&alias=%s&newAlias=%s&removeAlias=%s",
			self.basePath, intermediate_path, authorizable_id, http_util.encodeURIComponent(_operation), http_util.encodeURIComponent(current_password), http_util.encodeURIComponent(new_password), http_util.encodeURIComponent(re_password), http_util.encodeURIComponent(key_password), http_util.encodeURIComponent(key_store_pass), http_util.encodeURIComponent(alias), http_util.encodeURIComponent(new_alias), http_util.encodeURIComponent(remove_alias));
	})
...
function sling_api:post_authorizables(authorizable_id, intermediate_path, create_user, create_group, rep_password, profile_given_name)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/libs/granite/security/post/authorizables?authorizableId=%s&intermediatePath=%s&createUser=%s&createGroup=%s&rep:password=%s&profile/givenName=%s",
			self.basePath, http_util.encodeURIComponent(authorizable_id), http_util.encodeURIComponent(intermediate_path), http_util.encodeURIComponent(create_user), http_util.encodeURIComponent(create_group), http_util.encodeURIComponent(rep_password), http_util.encodeURIComponent(profile_given_name));
	})
...
function sling_api:post_node(path, name, _operation, delete_authorizable, file)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/%s/%s?:operation=%s&deleteAuthorizable=%s",
			self.basePath, path, name, http_util.encodeURIComponent(_operation), http_util.encodeURIComponent(delete_authorizable));
	})
...
function sling_api:post_path(path, jcr_primary_type, _name)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/%s?jcr:primaryType=%s&:name=%s",
			self.basePath, path, http_util.encodeURIComponent(jcr_primary_type), http_util.encodeURIComponent(_name));
	})
...
function sling_api:post_tree_activation(ignoredeactivated, onlymodified, path, cmd)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/libs/replication/treeactivation.html?ignoredeactivated=%s&onlymodified=%s&path=%s&cmd=%s",
			self.basePath, http_util.encodeURIComponent(ignoredeactivated), http_util.encodeURIComponent(onlymodified), http_util.encodeURIComponent(path), http_util.encodeURIComponent(cmd));
	})
...
function sling_api:post_truststore(_operation, new_password, re_password, key_store_type, remove_alias, certificate)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/libs/granite/security/post/truststore?:operation=%s&newPassword=%s&rePassword=%s&keyStoreType=%s&removeAlias=%s",
			self.basePath, http_util.encodeURIComponent(_operation), http_util.encodeURIComponent(new_password), http_util.encodeURIComponent(re_password), http_util.encodeURIComponent(key_store_type), http_util.encodeURIComponent(remove_alias));
	})
