## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Adobe Experience Manager (AEM) API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Adobe Experience Manager (AEM) API API.
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| AdobeExperienceManager(AEM).Client    | use the "dispatch" functions to send requests       |
| AdobeExperienceManager(AEM).Core      | core functions, config and request types            |
| AdobeExperienceManager(AEM).API       | construct api requests                              |
| AdobeExperienceManager(AEM).Model     | describes api models                                |
| AdobeExperienceManager(AEM).MimeTypes | encoding/decoding MIME types (content-types/accept) |
| AdobeExperienceManager(AEM).ModelLens | lenses for model fields                             |
| AdobeExperienceManager(AEM).Logging   | logging functions and utils                         |
