...
module AdobeExperienceManager(AEM).MimeTypes where
...
-- | @plain/text@
instance MimeType MimePlaintext where
  mimeType _ = Just $ P.fromString "plain/text"
-- instance MimeRender MimePlaintext T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimePlaintext T.Text where mimeUnrender _ = undefined
