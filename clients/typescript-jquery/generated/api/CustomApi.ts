...
export class CustomApi {
     ...
     */
    public postConfigAemHealthCheckServlet(bundlesIgnored?: Array<string>, bundlesIgnored@TypeHint?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        if (bundlesIgnored@TypeHint !== null && bundlesIgnored@TypeHint !== undefined) {
            queryParameters['bundles.ignored@TypeHint'] = <string><any>bundlesIgnored@TypeHint;
        }
     ...
     */
    public postConfigAemPasswordReset(pwdresetAuthorizables?: Array<string>, pwdresetAuthorizables@TypeHint?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        ...
        if (pwdresetAuthorizables@TypeHint !== null && pwdresetAuthorizables@TypeHint !== undefined) {
            queryParameters['pwdreset.authorizables@TypeHint'] = <string><any>pwdresetAuthorizables@TypeHint;
        }
