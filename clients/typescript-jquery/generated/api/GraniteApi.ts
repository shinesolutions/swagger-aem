...
export class GraniteApi {
     ...
     */
    public sslSetup(keystorePassword: string, keystorePasswordConfirm: string, truststorePassword: string, truststorePasswordConfirm: string, httpsHostname: string, httpsPort: string, privatekeyFile?: File, certificateFile?: File, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
