...
public interface SlingApi  {
    Future<ApiResponse<Void>> deleteAgent(String runmode, String name);
    Future<ApiResponse<Void>> deleteNode(String path, String name);
    Future<ApiResponse<Void>> getAgent(String runmode, String name);
    Future<ApiResponse<String>> getAgents(String runmode);
    Future<ApiResponse<KeystoreInfo>> getAuthorizableKeystore(String intermediatePath, String authorizableId);
    Future<ApiResponse<FileUpload>> getKeystore(String intermediatePath, String authorizableId);
    Future<ApiResponse<Void>> getNode(String path, String name);
    Future<ApiResponse<FileUpload>> getPackage(String group, String name, String version);
    Future<ApiResponse<String>> getPackageFilter(String group, String name, String version);
    Future<ApiResponse<String>> getQuery(String path, BigDecimal pLimit, String _1property, String _1propertyValue);
    Future<ApiResponse<FileUpload>> getTruststore();
    Future<ApiResponse<TruststoreInfo>> getTruststoreInfo();
    ...
    Future<ApiResponse<String>> postAuthorizables(String authorizableId, String intermediatePath, String createUser, String createGroup, String repPassword, String profileGivenName);
    ...
    Future<ApiResponse<Void>> postConfigApacheSlingDavExServlet(String alias, String aliasAtTypeHint, Boolean davCreateAbsoluteUri, String davCreateAbsoluteUriAtTypeHint);
    Future<ApiResponse<Void>> postConfigApacheSlingGetServlet(String jsonMaximumresults, String jsonMaximumresultsAtTypeHint, Boolean enableHtml, String enableHtmlAtTypeHint, Boolean enableTxt, String enableTxtAtTypeHint, Boolean enableXml, String enableXmlAtTypeHint);
    Future<ApiResponse<Void>> postConfigApacheSlingReferrerFilter(Boolean allowEmpty, String allowEmptyAtTypeHint, String allowHosts, String allowHostsAtTypeHint, String allowHostsRegexp, String allowHostsRegexpAtTypeHint, String filterMethods, String filterMethodsAtTypeHint);
    Future<ApiResponse<Void>> postConfigProperty(String configNodeName);
    Future<ApiResponse<Void>> postNode(String path, String name, String operation, String deleteAuthorizable, FileUpload _file);
    Future<ApiResponse<Void>> postNodeRw(String path, String name, String addMembers);
    Future<ApiResponse<Void>> postPath(String path, String jcrPrimaryType, String name);
    Future<ApiResponse<String>> postQuery(String path, BigDecimal pLimit, String _1property, String _1propertyValue);
    Future<ApiResponse<Void>> postTreeActivation(Boolean ignoredeactivated, Boolean onlymodified, String path, String cmd);
    Future<ApiResponse<String>> postTruststore(String operation, String newPassword, String rePassword, String keyStoreType, String removeAlias, FileUpload certificate);
    Future<ApiResponse<String>> postTruststorePKCS12(FileUpload truststoreP12);
}
