...
std::string SamlConfigurationProperties::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree SamlConfigurationProperties::toPropertyTree()
{
    return toPropertyTree_internal();
}

void SamlConfigurationProperties::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string SamlConfigurationProperties::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void SamlConfigurationProperties::fromJsonString_internal(std::string const& jsonString)
{
...
ptree SamlConfigurationProperties::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
	if (m_Path != nullptr) {
...
void SamlConfigurationProperties::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
