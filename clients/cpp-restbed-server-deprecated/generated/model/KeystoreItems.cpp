...
std::string KeystoreItems::toJsonString(bool prettyJson /* = false */)
{
...
boost::property_tree::ptree KeystoreItems::toPropertyTree()
{
    return toPropertyTree_internal();
}

void KeystoreItems::fromPropertyTree(boost::property_tree::ptree const& pt)
{
    fromPropertyTree_internal(pt);
}

std::string KeystoreItems::toJsonString_internal(bool prettyJson)
{
	std::stringstream ss;
...
void KeystoreItems::fromJsonString_internal(std::string const& jsonString)
{
...
ptree KeystoreItems::toPropertyTree_internal()
{
	ptree pt;
	ptree tmp_node;
...
void KeystoreItems::fromPropertyTree_internal(ptree const &pt)
{
	ptree tmp_node;
	...
	if (pt.get_child_optional("chain")) {
		for (const auto &childTree : pt.get_child("chain")) {
            std::shared_ptr<KeystoreChainItems> val =
                std::make_shared<KeystoreChainItems>(childTree.second);
            m_Chain.emplace_back(std::move(val));
		}
	}
}
