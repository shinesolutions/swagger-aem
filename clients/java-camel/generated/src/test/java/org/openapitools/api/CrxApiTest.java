...
public class CrxApiTest {
    ...
    @Test
    public void getInstallStatusTestJson() throws Exception {
        String contentType = "application/json";
        String accept = "application/json";
        String url = API_URL + "/crx/packmgr/installstatus.jsp";
    ...
    @Test
    public void getInstallStatusTestXml() throws Exception {
