...
class TruststoreItems(Model):
    ...
    def __init__(self, alias: str=None, entry_type: str=None, subject: str=None, issuer: str=None, not_before: str=None, not_after: str=None, serial_number: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'TruststoreItems':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The TruststoreItems of this TruststoreItems.
        """
