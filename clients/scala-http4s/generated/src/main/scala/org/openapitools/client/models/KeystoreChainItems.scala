...
object KeystoreChainItems {
  given encoderKeystoreChainItems: Encoder[KeystoreChainItems] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderKeystoreChainItems: Decoder[KeystoreChainItems] = Decoder.instance { c =>
    for {
