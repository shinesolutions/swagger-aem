...
get_crxde_status(Ctx, Optional) ->
    ...
    Method = get,
    Path = [?BASE_URL, "/crx/server/crx.default/jcr:root/.1.json"],
    QS = [],
    Headers = [],
    Body1 = [],
...
get_install_status(Ctx, Optional) ->
    ...
    Method = get,
    Path = [?BASE_URL, "/crx/packmgr/installstatus.jsp"],
    QS = [],
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
get_package_manager_servlet(Ctx, Optional) ->
    ...
    Method = get,
    Path = [?BASE_URL, "/crx/packmgr/service/script.html"],
    QS = [],
    Headers = [],
    Body1 = [],
    ContentTypeHeader = openapi_utils:select_header_content_type([]),
...
post_package_service(Ctx, Cmd, Optional) ->
    ...
    Method = post,
    Path = [?BASE_URL, "/crx/packmgr/service.jsp"],
...
post_package_service_json(Ctx, Path, Cmd, Optional) ->
    ...
    Method = post,
    Path = [?BASE_URL, "/crx/packmgr/service/.json/", Path, ""],
...
post_package_update(Ctx, GroupName, PackageName, Version, Path, Optional) ->
    ...
    Method = post,
    Path = [?BASE_URL, "/crx/packmgr/update.jsp"],
...
post_set_password(Ctx, Old, Plain, Verify, Optional) ->
    ...
    Method = post,
    Path = [?BASE_URL, "/crx/explorer/ui/setpassword.jsp"],
