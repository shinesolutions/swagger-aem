...
from app.openapi_server.models.bundle_info import BundleInfo  # noqa: E501
from app.openapi_server.models.saml_configuration_info import SamlConfigurationInfo  # noqa: E501
...
class TestConsoleController(BaseTestCase):
    ...
    def test_get_bundle_info(self):
        ...
        """
        response = self.client.open(
            '/system/console/bundles/{name_jso}'.format(name='name_example'),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
