...
from app.openapi_server.models.bundle_data import BundleData  # noqa: F401,E501
...
class BundleInfo(Model):
    ...
    def __init__(self, status: str=None, s: List[int]=None, data: List[BundleData]=None):  # noqa: E501
