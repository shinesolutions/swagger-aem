...
from app.openapi_server.models.truststore_items import TruststoreItems  # noqa: F401,E501
...
class TruststoreInfo(Model):
    ...
    def __init__(self, aliases: List[TruststoreItems]=None, exists: bool=None):  # noqa: E501
        """TruststoreInfo - a model defined in Swagger
    ...
    @property
    def aliases(self) -> List[TruststoreItems]:
    ...
    @aliases.setter
    def aliases(self, aliases: List[TruststoreItems]):
