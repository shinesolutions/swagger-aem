...
from app.openapi_server.models.keystore_chain_items import KeystoreChainItems  # noqa: F401,E501
...
class KeystoreItems(Model):
    ...
    def __init__(self, alias: str=None, entry_type: str=None, algorithm: str=None, format: str=None, chain: List[KeystoreChainItems]=None):  # noqa: E501
