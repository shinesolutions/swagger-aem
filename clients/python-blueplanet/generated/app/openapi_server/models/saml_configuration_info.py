...
from app.openapi_server.models.saml_configuration_properties import SamlConfigurationProperties  # noqa: F401,E501
...
class SamlConfigurationInfo(Model):
    ...
    def __init__(self, pid: str=None, title: str=None, description: str=None, bundle_location: str=None, service_location: str=None, properties: SamlConfigurationProperties=None):  # noqa: E501
        """SamlConfigurationInfo - a model defined in Swagger
