...
from app.openapi_server.models.saml_configuration_property_items_array import SamlConfigurationPropertyItemsArray  # noqa: F401,E501
from app.openapi_server.models.saml_configuration_property_items_boolean import SamlConfigurationPropertyItemsBoolean  # noqa: F401,E501
from app.openapi_server.models.saml_configuration_property_items_long import SamlConfigurationPropertyItemsLong  # noqa: F401,E501
from app.openapi_server.models.saml_configuration_property_items_string import SamlConfigurationPropertyItemsString  # noqa: F401,E501
...
class SamlConfigurationProperties(Model):
    ...
    def __init__(self, path: SamlConfigurationPropertyItemsArray=None, service_ranking: SamlConfigurationPropertyItemsLong=None, idp_url: SamlConfigurationPropertyItemsString=None, idp_cert_alias: SamlConfigurationPropertyItemsString=None, idp_http_redirect: SamlConfigurationPropertyItemsBoolean=None, service_provider_entity_id: SamlConfigurationPropertyItemsString=None, assertion_consumer_service_url: SamlConfigurationPropertyItemsString=None, sp_private_key_alias: SamlConfigurationPropertyItemsString=None, key_store_password: SamlConfigurationPropertyItemsString=None, default_redirect_url: SamlConfigurationPropertyItemsString=None, user_id_attribute: SamlConfigurationPropertyItemsString=None, use_encryption: SamlConfigurationPropertyItemsBoolean=None, create_user: SamlConfigurationPropertyItemsBoolean=None, add_group_memberships: SamlConfigurationPropertyItemsBoolean=None, group_membership_attribute: SamlConfigurationPropertyItemsString=None, default_groups: SamlConfigurationPropertyItemsArray=None, name_id_format: SamlConfigurationPropertyItemsString=None, synchronize_attributes: SamlConfigurationPropertyItemsArray=None, handle_logout: SamlConfigurationPropertyItemsBoolean=None, logout_url: SamlConfigurationPropertyItemsString=None, clock_tolerance: SamlConfigurationPropertyItemsLong=None, digest_method: SamlConfigurationPropertyItemsString=None, signature_method: SamlConfigurationPropertyItemsString=None, user_intermediate_path: SamlConfigurationPropertyItemsString=None):  # noqa: E501
