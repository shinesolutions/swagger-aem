...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'GetAemHealthCheck'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'PostConfigAemHealthCheckServlet'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'PostConfigAemPasswordReset'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'GetAemHealthCheck' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'PostConfigAemHealthCheckServlet' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'PostConfigAemPasswordReset' = OperationID,
        logic_handler = LogicHandler
    }
) ->
