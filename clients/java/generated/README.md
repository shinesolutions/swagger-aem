...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'swaggeraem4j' jar has been published to maven central.
    mavenLocal()       // Needed if the 'swaggeraem4j' jar has been published to the local maven repo.
  }
