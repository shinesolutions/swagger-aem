...
public class CqApi {
    ...
    private okhttp3.Call getLoginPageValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return getLoginPageCall(_callback);
     ...
     */
    public okhttp3.Call postCqActionsCall(@javax.annotation.Nonnull String authorizableId, @javax.annotation.Nonnull String changelog, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postCqActionsValidateBeforeCall(@javax.annotation.Nonnull String authorizableId, @javax.annotation.Nonnull String changelog, final ApiCallback _callback) throws ApiException {
        ...
        return postCqActionsCall(authorizableId, changelog, _callback);
     ...
     */
    public void postCqActions(@javax.annotation.Nonnull String authorizableId, @javax.annotation.Nonnull String changelog) throws ApiException {
     ...
     */
    public ApiResponse<Void> postCqActionsWithHttpInfo(@javax.annotation.Nonnull String authorizableId, @javax.annotation.Nonnull String changelog) throws ApiException {
     ...
     */
    public okhttp3.Call postCqActionsAsync(@javax.annotation.Nonnull String authorizableId, @javax.annotation.Nonnull String changelog, final ApiCallback<Void> _callback) throws ApiException {
