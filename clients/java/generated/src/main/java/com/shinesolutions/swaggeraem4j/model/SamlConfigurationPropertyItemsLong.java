...
public class SamlConfigurationPropertyItemsLong {
  ...
  public SamlConfigurationPropertyItemsLong name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public SamlConfigurationPropertyItemsLong optional(@javax.annotation.Nullable Boolean optional) {
  ...
  public SamlConfigurationPropertyItemsLong isSet(@javax.annotation.Nullable Boolean isSet) {
    this.isSet = isSet;
    return this;
  }
  ...
  public SamlConfigurationPropertyItemsLong type(@javax.annotation.Nullable Integer type) {
    this.type = type;
    return this;
  }
  ...
  public SamlConfigurationPropertyItemsLong value(@javax.annotation.Nullable Integer value) {
    this.value = value;
    return this;
  }
  ...
  public SamlConfigurationPropertyItemsLong description(@javax.annotation.Nullable String description) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SamlConfigurationPropertyItemsLong.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SamlConfigurationPropertyItemsLong is not found in the empty JSON string", SamlConfigurationPropertyItemsLong.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SamlConfigurationPropertyItemsLong.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SamlConfigurationPropertyItemsLong` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
