...
This Scala akka-http framework project was generated by OpenAPI Generator 7.24.0.
    ...
    ## API
          ...
          |Name|Role|
          |----|----|
          |`org.openapitools.server.api.ConsoleController`|akka-http API controller|
          |`org.openapitools.server.api.ConsoleApi`|Representing trait|
              |`org.openapitools.server.api.ConsoleApiImpl`|Default implementation|
          ...
          |Name|Role|
          |----|----|
          |`org.openapitools.server.api.CqController`|akka-http API controller|
          |`org.openapitools.server.api.CqApi`|Representing trait|
              |`org.openapitools.server.api.CqApiImpl`|Default implementation|
          ...
          |Name|Role|
          |----|----|
          |`org.openapitools.server.api.CrxController`|akka-http API controller|
          |`org.openapitools.server.api.CrxApi`|Representing trait|
              |`org.openapitools.server.api.CrxApiImpl`|Default implementation|
          ...
          |Name|Role|
          |----|----|
          |`org.openapitools.server.api.CustomController`|akka-http API controller|
          |`org.openapitools.server.api.CustomApi`|Representing trait|
              |`org.openapitools.server.api.CustomApiImpl`|Default implementation|
          ...
          |Name|Role|
          |----|----|
          |`org.openapitools.server.api.GraniteController`|akka-http API controller|
          |`org.openapitools.server.api.GraniteApi`|Representing trait|
              |`org.openapitools.server.api.GraniteApiImpl`|Default implementation|
          ...
          |Name|Role|
          |----|----|
          |`org.openapitools.server.api.SlingController`|akka-http API controller|
          |`org.openapitools.server.api.SlingApi`|Representing trait|
              |`org.openapitools.server.api.SlingApiImpl`|Default implementation|
