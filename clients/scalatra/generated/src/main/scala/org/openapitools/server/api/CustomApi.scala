...
class CustomApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val postConfigAemHealthCheckServletOperation = (apiOperation[Unit]("postConfigAemHealthCheckServlet")
    summary ""
    parameters(queryParam[List[String]]("bundlesPeriodignored").description("").optional, queryParam[String]("bundlesPeriodignoredAtTypeHint").description("").optional)
  )
  ...
  val postConfigAemPasswordResetOperation = (apiOperation[Unit]("postConfigAemPasswordReset")
    summary ""
    parameters(queryParam[List[String]]("pwdresetPeriodauthorizables").description("").optional, queryParam[String]("pwdresetPeriodauthorizablesAtTypeHint").description("").optional)
  )
