...
class SlingApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val getQueryOperation = (apiOperation[String]("getQuery")
    summary ""
    parameters(queryParam[String]("path").description(""), queryParam[BigDecimal]("pPeriodlimit").description(""), queryParam[String]("1Property").description(""), queryParam[String]("1PropertyPeriodvalue").description(""))
  )
  ...
  get("/bin/querybuilder.json", operation(getQueryOperation)) {
    ...
    //println("path: " + path)
            val pPeriodlimit = params.getAs[BigDecimal]("pPeriodlimit")
  ...
  post("/etc/replication/agents.{runmode}/:name", operation(postAgentOperation)) {
    ...
    //println("jcrContentSlashnoVersioning: " + jcrContentSlashnoVersioning)
            val jcrContentSlashprotocolConnectTimeout = params.getAs[BigDecimal]("jcrContentSlashprotocolConnectTimeout")
    ...
    //println("jcrContentSlashprotocolInterface: " + jcrContentSlashprotocolInterface)
            val jcrContentSlashprotocolSocketTimeout = params.getAs[BigDecimal]("jcrContentSlashprotocolSocketTimeout")
    ...
    //println("jcrContentSlashproxyPassword: " + jcrContentSlashproxyPassword)
            val jcrContentSlashproxyPort = params.getAs[BigDecimal]("jcrContentSlashproxyPort")
    ...
    //println("jcrContentSlashproxyUser: " + jcrContentSlashproxyUser)
            val jcrContentSlashqueueBatchMaxSize = params.getAs[BigDecimal]("jcrContentSlashqueueBatchMaxSize")
    ...
    //println("jcrContentSlashqueueBatchMode: " + jcrContentSlashqueueBatchMode)
            val jcrContentSlashqueueBatchWaitTime = params.getAs[BigDecimal]("jcrContentSlashqueueBatchWaitTime")
