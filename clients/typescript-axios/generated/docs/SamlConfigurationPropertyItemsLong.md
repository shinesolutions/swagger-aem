...
**value** | **number** | Property value | [optional] [default to undefined]
**description** | **string** | Property description | [optional] [default to undefined]

## Example

```typescript
import { SamlConfigurationPropertyItemsLong } from './api';

const instance: SamlConfigurationPropertyItemsLong = {
    name,
    optional,
    is_set,
    type,
