...
class CrxApi
{
    ...
    public function getCrxdeStatus(
        string $contentType = self::contentTypes['getCrxdeStatus'][0]
    ): string
    {
    ...
    public function getInstallStatus(
        string $contentType = self::contentTypes['getInstallStatus'][0]
    ): \OpenAPI\Client\Model\InstallStatus|string
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \OpenAPI\Client\Model\InstallStatus|string, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    ...
    public function getPackageManagerServlet(
        string $contentType = self::contentTypes['getPackageManagerServlet'][0]
    ): string
    {
        list($response) = $this->getPackageManagerServletWithHttpInfo($contentType);
        return $response;
    }
    ...
    public function postPackageService(
        string $cmd,
        string $contentType = self::contentTypes['postPackageService'][0]
    ): string
    {
     ...
     * @return array{0: string, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    public function postPackageServiceWithHttpInfo(
        string $cmd,
        string $contentType = self::contentTypes['postPackageService'][0]
    ): array
    {
     ...
     * @return PromiseInterface
     */
    public function postPackageServiceAsync(
        string $cmd,
        string $contentType = self::contentTypes['postPackageService'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function postPackageServiceAsyncWithHttpInfo(
        string $cmd,
        string $contentType = self::contentTypes['postPackageService'][0]
    ): PromiseInterface
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPackageServiceRequest(
        string $cmd,
        string $contentType = self::contentTypes['postPackageService'][0]
    ): Request
    {
    ...
    public function postPackageServiceJson(
        ...
        ?bool $force = null,
        ?bool $recursive = null,
        ?\SplFileObject $package = null,
        string $contentType = self::contentTypes['postPackageServiceJson'][0]
    ): string
    {
     ...
     * @return array{0: string, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    public function postPackageServiceJsonWithHttpInfo(
        string $path,
        string $cmd,
        ?string $group_name = null,
        ?string $package_name = null,
     ...
     * @return PromiseInterface
     */
    public function postPackageServiceJsonAsync(
        string $path,
        string $cmd,
        ?string $group_name = null,
        ?string $package_name = null,
     ...
     * @return PromiseInterface
     */
    public function postPackageServiceJsonAsyncWithHttpInfo(
        string $path,
        string $cmd,
        ?string $group_name = null,
        ?string $package_name = null,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPackageServiceJsonRequest(
        string $path,
        string $cmd,
        ?string $group_name = null,
        ?string $package_name = null,
    ...
    public function postPackageUpdate(
        ...
        ?string $filter = null,
        ?string $_charset_ = null,
        string $contentType = self::contentTypes['postPackageUpdate'][0]
    ): string
    {
     ...
     * @return array{0: string, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    public function postPackageUpdateWithHttpInfo(
        string $group_name,
        string $package_name,
        string $version,
        string $path,
     ...
     * @return PromiseInterface
     */
    public function postPackageUpdateAsync(
        string $group_name,
        string $package_name,
        string $version,
        string $path,
     ...
     * @return PromiseInterface
     */
    public function postPackageUpdateAsyncWithHttpInfo(
        string $group_name,
        string $package_name,
        string $version,
        string $path,
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postPackageUpdateRequest(
        string $group_name,
        string $package_name,
        string $version,
        string $path,
    ...
    public function postSetPassword(
        ...
        string $plain,
        string $verify,
        string $contentType = self::contentTypes['postSetPassword'][0]
    ): string
    {
     ...
     * @return array{0: string, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    public function postSetPasswordWithHttpInfo(
        string $old,
        string $plain,
        string $verify,
        string $contentType = self::contentTypes['postSetPassword'][0]
     ...
     * @return PromiseInterface
     */
    public function postSetPasswordAsync(
        string $old,
        string $plain,
        string $verify,
        string $contentType = self::contentTypes['postSetPassword'][0]
     ...
     * @return PromiseInterface
     */
    public function postSetPasswordAsyncWithHttpInfo(
        string $old,
        string $plain,
        string $verify,
        string $contentType = self::contentTypes['postSetPassword'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postSetPasswordRequest(
        string $old,
        string $plain,
        string $verify,
        string $contentType = self::contentTypes['postSetPassword'][0]
