...
class KeystoreInfo {
  ...
  static KeystoreInfo? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<KeystoreInfo> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <KeystoreInfo>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = KeystoreInfo.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, KeystoreInfo> mapFromJson(dynamic json) {
    final map = <String, KeystoreInfo>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = KeystoreInfo.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<KeystoreInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<KeystoreInfo>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = KeystoreInfo.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
