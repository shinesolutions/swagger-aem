...
$Manifest = @{
    ...
    Description = 'Org.OpenAPITools - the PowerShell module for Adobe Experience Manager (AEM) API'

    RootModule = 'Org.OpenAPITools.psm1'
    Guid = '{C1C7B14F-A114-40F1-8B80-D4A20447C51D}' # Has to be static, otherwise each new build will be considered different module
