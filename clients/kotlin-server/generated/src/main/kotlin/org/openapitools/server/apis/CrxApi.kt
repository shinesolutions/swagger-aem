...
fun Route.CrxApi() {
    ...
    get<Paths.getCrxdeStatus> {  it: Paths.getCrxdeStatus ->
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/crx/server/crx.default/jcr:root/.1.json' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }

    get<Paths.getInstallStatus> {  it: Paths.getInstallStatus ->
        val principal = call.authentication.principal<UserIdPrincipal>()
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/crx/packmgr/installstatus.jsp' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }

    get<Paths.getPackageManagerServlet> {  it: Paths.getPackageManagerServlet ->
        val principal = call.authentication.principal<UserIdPrincipal>()
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/crx/packmgr/service/script.html' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/crx/packmgr/service.jsp' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/crx/packmgr/service/.json/{path}' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/crx/packmgr/update.jsp' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
    ...
    .apply {
      ...
      //       It could be the authentication block is being abused here. Until this is resolved, swallow duplicate exceptions.
        ...
        try {
            ...
            application.environment.log.warn("authentication block for '/crx/explorer/ui/setpassword.jsp' is duplicated in code. " +
            "Generated endpoints may need to be merged under a 'route' entry.")
        }
    }
}
