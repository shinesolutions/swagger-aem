...
public class SlingAPI: APIBase {
     ...
     */
    public class func deleteAgent(runmode runmode: String, name: String, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - DELETE /etc/replication/agents.{runmode}/{name}     - BASIC:
       - type: http
       - name: aemAuth
     - parameter runmode: (path)  
     - parameter name: (path)  
     ...
     */
    public class func deleteAgentWithRequestBuilder(runmode runmode: String, name: String) -> RequestBuilder<Void> {
        var path = "/etc/replication/agents.{runmode}/{name}"
        path = path.stringByReplacingOccurrencesOfString("{runmode}", withString: "\(runmode)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func deleteNode(path path: String, name: String, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func deleteNodeWithRequestBuilder(path path: String, name: String) -> RequestBuilder<Void> {
        var path = "/{path}/{name}"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getAgent(runmode runmode: String, name: String, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /etc/replication/agents.{runmode}/{name}     - BASIC:
       - type: http
       - name: aemAuth
     - parameter runmode: (path)  
     - parameter name: (path)  
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getAgentWithRequestBuilder(runmode runmode: String, name: String) -> RequestBuilder<Void> {
        var path = "/etc/replication/agents.{runmode}/{name}"
        path = path.stringByReplacingOccurrencesOfString("{runmode}", withString: "\(runmode)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{name}", withString: "\(name)", options: .LiteralSearch, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getAgents(runmode runmode: String, completion: ((data: String?, error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /etc/replication/agents.{runmode}.-1.json     - BASIC:
       - type: http
       - name: aemAuth
     - parameter runmode: (path)  
     ...
     */
    public class func getAgentsWithRequestBuilder(runmode runmode: String) -> RequestBuilder<String> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getAuthorizableKeystore(intermediatePath intermediatePath: String, authorizableId: String, completion: ((data: KeystoreInfo?, error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /{intermediatePath}/{authorizableId}.ks.json     - BASIC:
       - type: http
       - name: aemAuth
     ...
     */
    public class func getAuthorizableKeystoreWithRequestBuilder(intermediatePath intermediatePath: String, authorizableId: String) -> RequestBuilder<KeystoreInfo> {
        var path = "/{intermediatePath}/{authorizableId}.ks.json"
        path = path.stringByReplacingOccurrencesOfString("{intermediatePath}", withString: "\(intermediatePath)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{authorizableId}", withString: "\(authorizableId)", options: .LiteralSearch, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getKeystore(intermediatePath intermediatePath: String, authorizableId: String, completion: ((data: NSURL?, error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /{intermediatePath}/{authorizableId}/keystore/store.p12     - BASIC:
       - type: http
       - name: aemAuth
     - parameter intermediatePath: (path)  
     - parameter authorizableId: (path)  
     ...
     */
    public class func getKeystoreWithRequestBuilder(intermediatePath intermediatePath: String, authorizableId: String) -> RequestBuilder<NSURL> {
        ...
        let requestBuilder: RequestBuilder<NSURL>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getNode(path path: String, name: String, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func getNodeWithRequestBuilder(path path: String, name: String) -> RequestBuilder<Void> {
        var path = "/{path}/{name}"
        path = path.stringByReplacingOccurrencesOfString("{path}", withString: "\(path)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{name}", withString: "\(name)", options: .LiteralSearch, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getPackage(group group: String, name: String, version: String, completion: ((data: NSURL?, error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /etc/packages/{group}/{name}-{version}.zip     - BASIC:
       - type: http
       - name: aemAuth
     - parameter group: (path)  
     - parameter name: (path)  
     ...
     - returns: RequestBuilder<NSURL> 
     */
    public class func getPackageWithRequestBuilder(group group: String, name: String, version: String) -> RequestBuilder<NSURL> {
        var path = "/etc/packages/{group}/{name}-{version}.zip"
        path = path.stringByReplacingOccurrencesOfString("{group}", withString: "\(group)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{name}", withString: "\(name)", options: .LiteralSearch, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getPackageFilter(group group: String, name: String, version: String, completion: ((data: String?, error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /etc/packages/{group}/{name}-{version}.zip/jcr:content/vlt:definition/filter.tidy.2.json     - BASIC:
       - type: http
       - name: aemAuth
     - parameter group: (path)  
     - parameter name: (path)  
     ...
     - returns: RequestBuilder<String> 
     */
    public class func getPackageFilterWithRequestBuilder(group group: String, name: String, version: String) -> RequestBuilder<String> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getQuery(path path: String, pLimit: Double, _1property: String, _1propertyValue: String, completion: ((data: String?, error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /bin/querybuilder.json     - BASIC:
       - type: http
       - name: aemAuth
     - parameter path: (query)  
     - parameter pLimit: (query)  
     ...
     - returns: RequestBuilder<String> 
     */
    public class func getQueryWithRequestBuilder(path path: String, pLimit: Double, _1property: String, _1propertyValue: String) -> RequestBuilder<String> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getTruststore(completion: ((data: NSURL?, error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /etc/truststore/truststore.p12     - BASIC:
       - type: http
       - name: aemAuth

     - returns: RequestBuilder<NSURL> 
     */
    public class func getTruststoreWithRequestBuilder() -> RequestBuilder<NSURL> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func getTruststoreInfo(completion: ((data: TruststoreInfo?, error: ErrorType?) -> Void)) {
    ...
    /**
     - GET /libs/granite/security/truststore.json     - BASIC:
       - type: http
       - name: aemAuth
  ...
  "exists" : true
     ...
     */
    public class func getTruststoreInfoWithRequestBuilder() -> RequestBuilder<TruststoreInfo> {
    ...
    /**
     - POST /etc/replication/agents.{runmode}/{name}     - BASIC:
       - type: http
       - name: aemAuth
     - parameter runmode: (path)  
     - parameter name: (path)  
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postAgentWithRequestBuilder(runmode runmode: String, name: String, jcrcontentcqdistribute: Bool? = nil, jcrcontentcqdistributeTypeHint: String? = nil, jcrcontentcqname: String? = nil, jcrcontentcqtemplate: String? = nil, jcrcontentenabled: Bool? = nil, jcrcontentjcrdescription: String? = nil, jcrcontentjcrlastModified: String? = nil, jcrcontentjcrlastModifiedBy: String? = nil, jcrcontentjcrmixinTypes: String? = nil, jcrcontentjcrtitle: String? = nil, jcrcontentlogLevel: String? = nil, jcrcontentnoStatusUpdate: Bool? = nil, jcrcontentnoVersioning: Bool? = nil, jcrcontentprotocolConnectTimeout: Double? = nil, jcrcontentprotocolHTTPConnectionClosed: Bool? = nil, jcrcontentprotocolHTTPExpired: String? = nil, jcrcontentprotocolHTTPHeaders: [String]? = nil, jcrcontentprotocolHTTPHeadersTypeHint: String? = nil, jcrcontentprotocolHTTPMethod: String? = nil, jcrcontentprotocolHTTPSRelaxed: Bool? = nil, jcrcontentprotocolInterface: String? = nil, jcrcontentprotocolSocketTimeout: Double? = nil, jcrcontentprotocolVersion: String? = nil, jcrcontentproxyNTLMDomain: String? = nil, jcrcontentproxyNTLMHost: String? = nil, jcrcontentproxyHost: String? = nil, jcrcontentproxyPassword: String? = nil, jcrcontentproxyPort: Double? = nil, jcrcontentproxyUser: String? = nil, jcrcontentqueueBatchMaxSize: Double? = nil, jcrcontentqueueBatchMode: String? = nil, jcrcontentqueueBatchWaitTime: Double? = nil, jcrcontentretryDelay: String? = nil, jcrcontentreverseReplication: Bool? = nil, jcrcontentserializationType: String? = nil, jcrcontentslingresourceType: String? = nil, jcrcontentssl: String? = nil, jcrcontenttransportNTLMDomain: String? = nil, jcrcontenttransportNTLMHost: String? = nil, jcrcontenttransportPassword: String? = nil, jcrcontenttransportUri: String? = nil, jcrcontenttransportUser: String? = nil, jcrcontenttriggerDistribute: Bool? = nil, jcrcontenttriggerModified: Bool? = nil, jcrcontenttriggerOnOffTime: Bool? = nil, jcrcontenttriggerReceive: Bool? = nil, jcrcontenttriggerSpecific: Bool? = nil, jcrcontentuserId: String? = nil, jcrprimaryType: String? = nil, operation: String? = nil) -> RequestBuilder<Void> {
        var path = "/etc/replication/agents.{runmode}/{name}"
        path = path.stringByReplacingOccurrencesOfString("{runmode}", withString: "\(runmode)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{name}", withString: "\(name)", options: .LiteralSearch, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postAuthorizableKeystore(intermediatePath intermediatePath: String, authorizableId: String, operation: String? = nil, currentPassword: String? = nil, newPassword: String? = nil, rePassword: String? = nil, keyPassword: String? = nil, keyStorePass: String? = nil, alias: String? = nil, newAlias: String? = nil, removeAlias: String? = nil, certChain: NSURL? = nil, pk: NSURL? = nil, keyStore: NSURL? = nil, completion: ((data: KeystoreInfo?, error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /{intermediatePath}/{authorizableId}.ks.html     - BASIC:
       - type: http
       - name: aemAuth
     - examples: [{output=none}]
     - parameter intermediatePath: (path)  
     ...
     - returns: RequestBuilder<KeystoreInfo> 
     */
    public class func postAuthorizableKeystoreWithRequestBuilder(intermediatePath intermediatePath: String, authorizableId: String, operation: String? = nil, currentPassword: String? = nil, newPassword: String? = nil, rePassword: String? = nil, keyPassword: String? = nil, keyStorePass: String? = nil, alias: String? = nil, newAlias: String? = nil, removeAlias: String? = nil, certChain: NSURL? = nil, pk: NSURL? = nil, keyStore: NSURL? = nil) -> RequestBuilder<KeystoreInfo> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postAuthorizables(authorizableId authorizableId: String, intermediatePath: String, createUser: String? = nil, createGroup: String? = nil, reppassword: String? = nil, profilegivenName: String? = nil, completion: ((data: String?, error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /libs/granite/security/post/authorizables     - BASIC:
       - type: http
       - name: aemAuth
     - parameter authorizableId: (query)  
     - parameter intermediatePath: (query)  
     ...
     - returns: RequestBuilder<String> 
     */
    public class func postAuthorizablesWithRequestBuilder(authorizableId authorizableId: String, intermediatePath: String, createUser: String? = nil, createGroup: String? = nil, reppassword: String? = nil, profilegivenName: String? = nil) -> RequestBuilder<String> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postConfigAdobeGraniteSamlAuthenticationHandler(keyStorePassword keyStorePassword: String? = nil, keyStorePasswordTypeHint: String? = nil, serviceRanking: Int32? = nil, serviceRankingTypeHint: String? = nil, idpHttpRedirect: Bool? = nil, idpHttpRedirectTypeHint: String? = nil, createUser: Bool? = nil, createUserTypeHint: String? = nil, defaultRedirectUrl: String? = nil, defaultRedirectUrlTypeHint: String? = nil, userIDAttribute: String? = nil, userIDAttributeTypeHint: String? = nil, defaultGroups: [String]? = nil, defaultGroupsTypeHint: String? = nil, idpCertAlias: String? = nil, idpCertAliasTypeHint: String? = nil, addGroupMemberships: Bool? = nil, addGroupMembershipsTypeHint: String? = nil, path: [String]? = nil, pathTypeHint: String? = nil, synchronizeAttributes: [String]? = nil, synchronizeAttributesTypeHint: String? = nil, clockTolerance: Int32? = nil, clockToleranceTypeHint: String? = nil, groupMembershipAttribute: String? = nil, groupMembershipAttributeTypeHint: String? = nil, idpUrl: String? = nil, idpUrlTypeHint: String? = nil, logoutUrl: String? = nil, logoutUrlTypeHint: String? = nil, serviceProviderEntityId: String? = nil, serviceProviderEntityIdTypeHint: String? = nil, assertionConsumerServiceURL: String? = nil, assertionConsumerServiceURLTypeHint: String? = nil, handleLogout: Bool? = nil, handleLogoutTypeHint: String? = nil, spPrivateKeyAlias: String? = nil, spPrivateKeyAliasTypeHint: String? = nil, useEncryption: Bool? = nil, useEncryptionTypeHint: String? = nil, nameIdFormat: String? = nil, nameIdFormatTypeHint: String? = nil, digestMethod: String? = nil, digestMethodTypeHint: String? = nil, signatureMethod: String? = nil, signatureMethodTypeHint: String? = nil, userIntermediatePath: String? = nil, userIntermediatePathTypeHint: String? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /apps/system/config/com.adobe.granite.auth.saml.SamlAuthenticationHandler.config     - BASIC:
       - type: http
       - name: aemAuth
     - parameter keyStorePassword: (query)  (optional)
     - parameter keyStorePasswordTypeHint: (query)  (optional)
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postConfigAdobeGraniteSamlAuthenticationHandlerWithRequestBuilder(keyStorePassword keyStorePassword: String? = nil, keyStorePasswordTypeHint: String? = nil, serviceRanking: Int32? = nil, serviceRankingTypeHint: String? = nil, idpHttpRedirect: Bool? = nil, idpHttpRedirectTypeHint: String? = nil, createUser: Bool? = nil, createUserTypeHint: String? = nil, defaultRedirectUrl: String? = nil, defaultRedirectUrlTypeHint: String? = nil, userIDAttribute: String? = nil, userIDAttributeTypeHint: String? = nil, defaultGroups: [String]? = nil, defaultGroupsTypeHint: String? = nil, idpCertAlias: String? = nil, idpCertAliasTypeHint: String? = nil, addGroupMemberships: Bool? = nil, addGroupMembershipsTypeHint: String? = nil, path: [String]? = nil, pathTypeHint: String? = nil, synchronizeAttributes: [String]? = nil, synchronizeAttributesTypeHint: String? = nil, clockTolerance: Int32? = nil, clockToleranceTypeHint: String? = nil, groupMembershipAttribute: String? = nil, groupMembershipAttributeTypeHint: String? = nil, idpUrl: String? = nil, idpUrlTypeHint: String? = nil, logoutUrl: String? = nil, logoutUrlTypeHint: String? = nil, serviceProviderEntityId: String? = nil, serviceProviderEntityIdTypeHint: String? = nil, assertionConsumerServiceURL: String? = nil, assertionConsumerServiceURLTypeHint: String? = nil, handleLogout: Bool? = nil, handleLogoutTypeHint: String? = nil, spPrivateKeyAlias: String? = nil, spPrivateKeyAliasTypeHint: String? = nil, useEncryption: Bool? = nil, useEncryptionTypeHint: String? = nil, nameIdFormat: String? = nil, nameIdFormatTypeHint: String? = nil, digestMethod: String? = nil, digestMethodTypeHint: String? = nil, signatureMethod: String? = nil, signatureMethodTypeHint: String? = nil, userIntermediatePath: String? = nil, userIntermediatePathTypeHint: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postConfigApacheFelixJettyBasedHttpService(orgApacheFelixHttpsNio orgApacheFelixHttpsNio: Bool? = nil, orgApacheFelixHttpsNioTypeHint: String? = nil, orgApacheFelixHttpsKeystore: String? = nil, orgApacheFelixHttpsKeystoreTypeHint: String? = nil, orgApacheFelixHttpsKeystorePassword: String? = nil, orgApacheFelixHttpsKeystorePasswordTypeHint: String? = nil, orgApacheFelixHttpsKeystoreKey: String? = nil, orgApacheFelixHttpsKeystoreKeyTypeHint: String? = nil, orgApacheFelixHttpsKeystoreKeyPassword: String? = nil, orgApacheFelixHttpsKeystoreKeyPasswordTypeHint: String? = nil, orgApacheFelixHttpsTruststore: String? = nil, orgApacheFelixHttpsTruststoreTypeHint: String? = nil, orgApacheFelixHttpsTruststorePassword: String? = nil, orgApacheFelixHttpsTruststorePasswordTypeHint: String? = nil, orgApacheFelixHttpsClientcertificate: String? = nil, orgApacheFelixHttpsClientcertificateTypeHint: String? = nil, orgApacheFelixHttpsEnable: Bool? = nil, orgApacheFelixHttpsEnableTypeHint: String? = nil, orgOsgiServiceHttpPortSecure: String? = nil, orgOsgiServiceHttpPortSecureTypeHint: String? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /apps/system/config/org.apache.felix.http     - BASIC:
       - type: http
       - name: aemAuth
     - parameter orgApacheFelixHttpsNio: (query)  (optional)
     - parameter orgApacheFelixHttpsNioTypeHint: (query)  (optional)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postConfigApacheHttpComponentsProxyConfiguration(proxyHost proxyHost: String? = nil, proxyHostTypeHint: String? = nil, proxyPort: Int32? = nil, proxyPortTypeHint: String? = nil, proxyExceptions: [String]? = nil, proxyExceptionsTypeHint: String? = nil, proxyEnabled: Bool? = nil, proxyEnabledTypeHint: String? = nil, proxyUser: String? = nil, proxyUserTypeHint: String? = nil, proxyPassword: String? = nil, proxyPasswordTypeHint: String? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /apps/system/config/org.apache.http.proxyconfigurator.config     - BASIC:
       - type: http
       - name: aemAuth
     - parameter proxyHost: (query)  (optional)
     - parameter proxyHostTypeHint: (query)  (optional)
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postConfigApacheHttpComponentsProxyConfigurationWithRequestBuilder(proxyHost proxyHost: String? = nil, proxyHostTypeHint: String? = nil, proxyPort: Int32? = nil, proxyPortTypeHint: String? = nil, proxyExceptions: [String]? = nil, proxyExceptionsTypeHint: String? = nil, proxyEnabled: Bool? = nil, proxyEnabledTypeHint: String? = nil, proxyUser: String? = nil, proxyUserTypeHint: String? = nil, proxyPassword: String? = nil, proxyPasswordTypeHint: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postConfigApacheSlingDavExServlet(alias alias: String? = nil, aliasTypeHint: String? = nil, davCreateAbsoluteUri: Bool? = nil, davCreateAbsoluteUriTypeHint: String? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /apps/system/config/org.apache.sling.jcr.davex.impl.servlets.SlingDavExServlet     - BASIC:
       - type: http
       - name: aemAuth
     - parameter alias: (query)  (optional)
     - parameter aliasTypeHint: (query)  (optional)
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postConfigApacheSlingDavExServletWithRequestBuilder(alias alias: String? = nil, aliasTypeHint: String? = nil, davCreateAbsoluteUri: Bool? = nil, davCreateAbsoluteUriTypeHint: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postConfigApacheSlingGetServlet(jsonMaximumresults jsonMaximumresults: String? = nil, jsonMaximumresultsTypeHint: String? = nil, enableHtml: Bool? = nil, enableHtmlTypeHint: String? = nil, enableTxt: Bool? = nil, enableTxtTypeHint: String? = nil, enableXml: Bool? = nil, enableXmlTypeHint: String? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /apps/system/config/org.apache.sling.servlets.get.DefaultGetServlet     - BASIC:
       - type: http
       - name: aemAuth
     - parameter jsonMaximumresults: (query)  (optional)
     - parameter jsonMaximumresultsTypeHint: (query)  (optional)
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postConfigApacheSlingGetServletWithRequestBuilder(jsonMaximumresults jsonMaximumresults: String? = nil, jsonMaximumresultsTypeHint: String? = nil, enableHtml: Bool? = nil, enableHtmlTypeHint: String? = nil, enableTxt: Bool? = nil, enableTxtTypeHint: String? = nil, enableXml: Bool? = nil, enableXmlTypeHint: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postConfigApacheSlingReferrerFilter(allowEmpty allowEmpty: Bool? = nil, allowEmptyTypeHint: String? = nil, allowHosts: String? = nil, allowHostsTypeHint: String? = nil, allowHostsRegexp: String? = nil, allowHostsRegexpTypeHint: String? = nil, filterMethods: String? = nil, filterMethodsTypeHint: String? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /apps/system/config/org.apache.sling.security.impl.ReferrerFilter     - BASIC:
       - type: http
       - name: aemAuth
     - parameter allowEmpty: (query)  (optional)
     - parameter allowEmptyTypeHint: (query)  (optional)
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postConfigApacheSlingReferrerFilterWithRequestBuilder(allowEmpty allowEmpty: Bool? = nil, allowEmptyTypeHint: String? = nil, allowHosts: String? = nil, allowHostsTypeHint: String? = nil, allowHostsRegexp: String? = nil, allowHostsRegexpTypeHint: String? = nil, filterMethods: String? = nil, filterMethodsTypeHint: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postNode(path path: String, name: String, operation: String? = nil, deleteAuthorizable: String? = nil, file: NSURL? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postNodeWithRequestBuilder(path path: String, name: String, operation: String? = nil, deleteAuthorizable: String? = nil, file: NSURL? = nil) -> RequestBuilder<Void> {
        var path = "/{path}/{name}"
        path = path.stringByReplacingOccurrencesOfString("{path}", withString: "\(path)", options: .LiteralSearch, range: nil)
        path = path.stringByReplacingOccurrencesOfString("{name}", withString: "\(name)", options: .LiteralSearch, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postNodeRw(path path: String, name: String, addMembers: String? = nil, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postNodeRwWithRequestBuilder(path path: String, name: String, addMembers: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postPath(path path: String, jcrprimaryType: String, name: String, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postPathWithRequestBuilder(path path: String, jcrprimaryType: String, name: String) -> RequestBuilder<Void> {
        var path = "/{path}/"
        path = path.stringByReplacingOccurrencesOfString("{path}", withString: "\(path)", options: .LiteralSearch, range: nil)
        let URLString = OpenAPIClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postQuery(path path: String, pLimit: Double, _1property: String, _1propertyValue: String, completion: ((data: String?, error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /bin/querybuilder.json     - BASIC:
       - type: http
       - name: aemAuth
     - parameter path: (query)  
     - parameter pLimit: (query)  
     ...
     - returns: RequestBuilder<String> 
     */
    public class func postQueryWithRequestBuilder(path path: String, pLimit: Double, _1property: String, _1propertyValue: String) -> RequestBuilder<String> {
        let path = "/bin/querybuilder.json"
        let URLString = OpenAPIClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postTreeActivation(ignoredeactivated ignoredeactivated: Bool, onlymodified: Bool, path: String, completion: ((error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /etc/replication/treeactivation.html     - BASIC:
       - type: http
       - name: aemAuth
     - parameter ignoredeactivated: (query)  
     - parameter onlymodified: (query)  
     ...
     - returns: RequestBuilder<Void> 
     */
    public class func postTreeActivationWithRequestBuilder(ignoredeactivated ignoredeactivated: Bool, onlymodified: Bool, path: String) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postTruststore(operation operation: String? = nil, newPassword: String? = nil, rePassword: String? = nil, keyStoreType: String? = nil, removeAlias: String? = nil, certificate: NSURL? = nil, completion: ((data: String?, error: ErrorType?) -> Void)) {
    ...
    /**
     - POST /libs/granite/security/post/truststore     - BASIC:
       - type: http
       - name: aemAuth
     - parameter operation: (query)  (optional)
     - parameter newPassword: (query)  (optional)
     ...
     - returns: RequestBuilder<String> 
     */
    public class func postTruststoreWithRequestBuilder(operation operation: String? = nil, newPassword: String? = nil, rePassword: String? = nil, keyStoreType: String? = nil, removeAlias: String? = nil, certificate: NSURL? = nil) -> RequestBuilder<String> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    public class func postTruststorePKCS12(truststoreP12 truststoreP12: NSURL? = nil, completion: ((data: String?, error: ErrorType?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<String> 
     */
    public class func postTruststorePKCS12WithRequestBuilder(truststoreP12 truststoreP12: NSURL? = nil) -> RequestBuilder<String> {
