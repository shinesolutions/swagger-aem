...
SlingApiImpl::SlingApiImpl(Pistache::Address addr)
    : SlingApi(addr)
    { }
...
void SlingApiImpl::get_query(const Pistache::Optional<std::string> &path, const Pistache::Optional<double> &pPeriodlimit, const Pistache::Optional<std::string> &_1_property, const Pistache::Optional<std::string> &_1_property_value, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
...
void SlingApiImpl::post_query(const Pistache::Optional<std::string> &path, const Pistache::Optional<double> &pPeriodlimit, const Pistache::Optional<std::string> &_1_property, const Pistache::Optional<std::string> &_1_property_value, Pistache::Http::ResponseWriter &response) {
    response.send(Pistache::Http::Code::Ok, "Do some magic\n");
}
