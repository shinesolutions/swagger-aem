...
public:
    ...
    void post_config_apache_http_components_proxy_configuration(const Pistache::Optional<std::string> &proxyPeriodhost, const Pistache::Optional<std::string> &proxyPeriodhostAtTypeHint, const Pistache::Optional<int32_t> &proxyPeriodport, const Pistache::Optional<std::string> &proxyPeriodportAtTypeHint, const Pistache::Optional<std::string> &proxyPeriodexceptions, const Pistache::Optional<std::string> &proxyPeriodexceptionsAtTypeHint, const Pistache::Optional<bool> &proxyPeriodenabled, const Pistache::Optional<std::string> &proxyPeriodenabledAtTypeHint, const Pistache::Optional<std::string> &proxyPerioduser, const Pistache::Optional<std::string> &proxyPerioduserAtTypeHint, const Pistache::Optional<std::string> &proxyPeriodpassword, const Pistache::Optional<std::string> &proxyPeriodpasswordAtTypeHint, Pistache::Http::ResponseWriter &response);
    void post_config_apache_sling_dav_ex_servlet(const Pistache::Optional<std::string> &alias, const Pistache::Optional<std::string> &aliasAtTypeHint, const Pistache::Optional<bool> &davPeriodcreateAbsoluteUri, const Pistache::Optional<std::string> &davPeriodcreateAbsoluteUriAtTypeHint, Pistache::Http::ResponseWriter &response);
    void post_config_apache_sling_get_servlet(const Pistache::Optional<std::string> &jsonPeriodmaximumresults, const Pistache::Optional<std::string> &jsonPeriodmaximumresultsAtTypeHint, const Pistache::Optional<bool> &enablePeriodhtml, const Pistache::Optional<std::string> &enablePeriodhtmlAtTypeHint, const Pistache::Optional<bool> &enablePeriodtxt, const Pistache::Optional<std::string> &enablePeriodtxtAtTypeHint, const Pistache::Optional<bool> &enablePeriodxml, const Pistache::Optional<std::string> &enablePeriodxmlAtTypeHint, Pistache::Http::ResponseWriter &response);
    void post_config_apache_sling_referrer_filter(const Pistache::Optional<bool> &allowPeriodempty, const Pistache::Optional<std::string> &allowPeriodemptyAtTypeHint, const Pistache::Optional<std::string> &allowPeriodhosts, const Pistache::Optional<std::string> &allowPeriodhostsAtTypeHint, const Pistache::Optional<std::string> &allowPeriodhostsPeriodregexp, const Pistache::Optional<std::string> &allowPeriodhostsPeriodregexpAtTypeHint, const Pistache::Optional<std::string> &filterPeriodmethods, const Pistache::Optional<std::string> &filterPeriodmethodsAtTypeHint, Pistache::Http::ResponseWriter &response);
    void post_node(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter &response);
    void post_node_rw(const std::string &path, const std::string &name, const Pistache::Optional<std::string> &addMembers, Pistache::Http::ResponseWriter &response);
    void post_path(const std::string &path, const Pistache::Optional<std::string> &jcrPrimaryType, const Pistache::Optional<std::string> &name, Pistache::Http::ResponseWriter &response);
    void post_query(const Pistache::Optional<std::string> &path, const Pistache::Optional<double> &pPeriodlimit, const Pistache::Optional<std::string> &_1_property, const Pistache::Optional<std::string> &_1_property_value, Pistache::Http::ResponseWriter &response);
    void post_tree_activation(const Pistache::Optional<bool> &ignoredeactivated, const Pistache::Optional<bool> &onlymodified, const Pistache::Optional<std::string> &path, Pistache::Http::ResponseWriter &response);
