...
public:
    ...
    void get_query(const Pistache::Optional<std::string> &path, const Pistache::Optional<double> &pPeriodlimit, const Pistache::Optional<std::string> &r_1_property, const Pistache::Optional<std::string> &r_1_property_value, Pistache::Http::ResponseWriter &response);
    ...
    void post_config_property(const std::string &configNodeName, Pistache::Http::ResponseWriter &response);
    ...
    void post_query(const Pistache::Optional<std::string> &path, const Pistache::Optional<double> &pPeriodlimit, const Pistache::Optional<std::string> &r_1_property, const Pistache::Optional<std::string> &r_1_property_value, Pistache::Http::ResponseWriter &response);
