...
public:
    ...
    void post_cq_actions(const HttpBasicCredentials &credentials,const std::optional<std::string> &authorizableId, const std::optional<std::string> &changelog, Pistache::Http::ResponseWriter &response);
