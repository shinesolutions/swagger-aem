...
private:
    ...
    virtual void get_aem_health_check(const HttpBasicCredentials &credentials,  const std::optional<std::string> &tags, const std::optional<bool> &combineTagsOr, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    virtual void post_config_aem_health_check_servlet(const HttpBasicCredentials &credentials,  const std::optional<std::vector<std::string>> &bundlesPeriodignored, const std::optional<std::string> &bundlesPeriodignoredAtTypeHint, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// 
    /// </summary>
    /// <remarks>
    ...
    virtual void post_config_aem_password_reset(const HttpBasicCredentials &credentials,  const std::optional<std::vector<std::string>> &pwdresetPeriodauthorizables, const std::optional<std::string> &pwdresetPeriodauthorizablesAtTypeHint, Pistache::Http::ResponseWriter &response) = 0;
