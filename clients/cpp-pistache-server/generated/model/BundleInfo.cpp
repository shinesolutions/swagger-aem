...
bool BundleInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (dataIsSet())
    {
        const std::vector<org::openapitools::server::model::BundleData>& value = m_Data;
        ...
        { // Recursive validation of array elements
            const std::string oldValuePath = currentValuePath;
            int i = 0;
            for (const org::openapitools::server::model::BundleData& value : value)
            { 
                const std::string currentValuePath = oldValuePath + "[" + std::to_string(i) + "]";
...
std::vector<org::openapitools::server::model::BundleData> BundleInfo::getData() const
{
    return m_Data;
}
void BundleInfo::setData(std::vector<org::openapitools::server::model::BundleData> const& value)
{
    m_Data = value;
    m_DataIsSet = true;
}
