...
public:
    ...
    bool operator==(const TruststoreItems& rhs) const;
    bool operator!=(const TruststoreItems& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const TruststoreItems& o);
    friend void from_json(const nlohmann::json& j, TruststoreItems& o);
protected:
    std::string m_Alias;
    bool m_AliasIsSet;
