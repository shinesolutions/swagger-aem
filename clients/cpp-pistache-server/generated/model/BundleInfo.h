...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::BundleData> getData() const;
    void setData(std::vector<org::openapitools::server::model::BundleData> const& value);
...
protected:
    ...
    bool m_sIsSet;
    std::vector<org::openapitools::server::model::BundleData> m_Data;
    bool m_DataIsSet;
