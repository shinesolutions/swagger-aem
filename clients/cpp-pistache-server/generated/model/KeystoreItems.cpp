...
bool KeystoreItems::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (chainIsSet())
    {
        const std::vector<org::openapitools::server::model::KeystoreChainItems>& value = m_Chain;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::KeystoreChainItems& value : value)
            { 
...
std::vector<org::openapitools::server::model::KeystoreChainItems> KeystoreItems::getChain() const
{
    return m_Chain;
}
void KeystoreItems::setChain(std::vector<org::openapitools::server::model::KeystoreChainItems> const& value)
{
    m_Chain = value;
    m_ChainIsSet = true;
}
