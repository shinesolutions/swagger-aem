...
bool TruststoreInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (aliasesIsSet())
    {
        const std::vector<TruststoreItems>& value = m_Aliases;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const TruststoreItems& value : value)
            { 
...
void TruststoreInfo::setAliases(std::vector<TruststoreItems> const& value)
{
    m_Aliases = value;
    m_AliasesIsSet = true;
}
