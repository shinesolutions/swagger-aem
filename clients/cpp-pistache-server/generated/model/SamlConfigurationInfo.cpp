...
org::openapitools::server::model::SamlConfigurationProperties SamlConfigurationInfo::getProperties() const
{
    return m_Properties;
}
void SamlConfigurationInfo::setProperties(org::openapitools::server::model::SamlConfigurationProperties const& value)
{
    m_Properties = value;
