...
bool KeystoreInfo::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (aliasesIsSet())
    {
        const std::vector<org::openapitools::server::model::KeystoreItems>& value = m_Aliases;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::KeystoreItems& value : value)
            { 
...
std::vector<org::openapitools::server::model::KeystoreItems> KeystoreInfo::getAliases() const
{
    return m_Aliases;
}
void KeystoreInfo::setAliases(std::vector<org::openapitools::server::model::KeystoreItems> const& value)
{
    m_Aliases = value;
    m_AliasesIsSet = true;
}
