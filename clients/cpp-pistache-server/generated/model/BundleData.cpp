...
bool BundleData::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (propsIsSet())
    {
        const std::vector<org::openapitools::server::model::BundleDataProp>& value = m_Props;
        ...
        { // Recursive validation of array elements
            ...
            int i = 0;
            for (const org::openapitools::server::model::BundleDataProp& value : value)
            { 
...
std::vector<org::openapitools::server::model::BundleDataProp> BundleData::getProps() const
{
    return m_Props;
}
void BundleData::setProps(std::vector<org::openapitools::server::model::BundleDataProp> const& value)
{
    m_Props = value;
    m_PropsIsSet = true;
}
