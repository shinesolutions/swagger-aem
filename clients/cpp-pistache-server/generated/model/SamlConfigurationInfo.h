...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::SamlConfigurationProperties getProperties() const;
    void setProperties(org::openapitools::server::model::SamlConfigurationProperties const& value);
...
protected:
    ...
    org::openapitools::server::model::SamlConfigurationProperties m_Properties;
