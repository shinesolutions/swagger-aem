...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::KeystoreChainItems> getChain() const;
    void setChain(std::vector<org::openapitools::server::model::KeystoreChainItems> const& value);
...
protected:
    ...
    std::string m_Format;
    bool m_FormatIsSet;
    std::vector<org::openapitools::server::model::KeystoreChainItems> m_Chain;
    bool m_ChainIsSet;
