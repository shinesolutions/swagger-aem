...
public:
    ...
    bool operator==(const SamlConfigurationPropertyItemsLong& rhs) const;
    bool operator!=(const SamlConfigurationPropertyItemsLong& rhs) const;
    ...
    friend void to_json(nlohmann::json& j, const SamlConfigurationPropertyItemsLong& o);
    friend void from_json(const nlohmann::json& j, SamlConfigurationPropertyItemsLong& o);
protected:
    std::string m_Name;
    bool m_NameIsSet;
    bool m_Optional;
