...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::BundleDataProp> getProps() const;
    void setProps(std::vector<org::openapitools::server::model::BundleDataProp> const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::BundleDataProp> m_Props;
    bool m_PropsIsSet;
