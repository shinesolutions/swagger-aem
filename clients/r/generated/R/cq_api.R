...
CqApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return character
    GetLoginPage = function(data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$GetLoginPageWithHttpInfo(data_file = data_file, ..., .parse = .parse)
    ...
    GetLoginPageWithHttpInfo = function(data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_url_path <- "/libs/granite/core/content/login.html"
    ...
    #'
    #' @return void
    PostCqActions = function(authorizable_id, changelog, ...) {
      local_var_response <- self$PostCqActionsWithHttpInfo(authorizable_id, changelog, ...)
      if (local_var_response$status_code >= 200 && local_var_response$status_code <= 299) {
        return(local_var_response$content)
      } else if (local_var_response$status_code >= 300 && local_var_response$status_code <= 399) {
        return(local_var_response)
    ...
    PostCqActionsWithHttpInfo = function(authorizable_id, changelog, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      if (!missing(`authorizable_id`) && is.null(`authorizable_id`)) {
        stop("Invalid value for `authorizable_id` when calling CqApi$PostCqActions, `authorizable_id` is not nullable")
      }

      if (!missing(`changelog`) && is.null(`changelog`)) {
        stop("Invalid value for `changelog` when calling CqApi$PostCqActions, `changelog` is not nullable")
      }
      ...
      local_var_url_path <- "/.cqactions.html"
      # HTTP basic auth
