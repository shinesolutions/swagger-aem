...
class CustomController extends Controller
{
    ...
    public function postConfigAemHealthCheckServletAction(Request $request)
    {
        ...
        // Read out all input parameter values into variables
        $bundlesIgnored = $request->query->get('bundles.ignored');
        $bundlesIgnoredTypeHint = $request->query->get('bundles.ignored@TypeHint');
        ...
        try {
            ...
            $handler->postConfigAemHealthCheckServlet($bundlesIgnored, $bundlesIgnoredTypeHint, $responseCode, $responseHeaders);
    ...
    public function postConfigAemPasswordResetAction(Request $request)
    {
        ...
        // Read out all input parameter values into variables
        $pwdresetAuthorizables = $request->query->get('pwdreset.authorizables');
        $pwdresetAuthorizablesTypeHint = $request->query->get('pwdreset.authorizables@TypeHint');
        ...
        try {
            ...
            $handler->postConfigAemPasswordReset($pwdresetAuthorizables, $pwdresetAuthorizablesTypeHint, $responseCode, $responseHeaders);
