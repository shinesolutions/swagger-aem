...
class CqApi implements CqApiInterface
{
     ...
     */
    public function getLoginPage(int &$responseCode, array &$responseHeaders): string
    {
...
class CqApi implements CqApiInterface
{
     ...
     */
    public function postCqActions(string $authorizableId, string $changelog, int &$responseCode, array &$responseHeaders): void
    {
        // Implement the operation ...
    }
