...
class CrxApi implements CrxApiInterface
{
     ...
     */
    public function getCrxdeStatus(int &$responseCode, array &$responseHeaders): string
    {
...
class CrxApi implements CrxApiInterface
{
     ...
     */
    public function getInstallStatus(int &$responseCode, array &$responseHeaders): array|object|null
    {
        // Implement the operation ...
    }
...
class CrxApi implements CrxApiInterface
{
     ...
     */
    public function getPackageManagerServlet(int &$responseCode, array &$responseHeaders): void
    {
        // Implement the operation ...
    }
...
class CrxApi implements CrxApiInterface
{
     ...
     */
    public function postPackageService(string $cmd, int &$responseCode, array &$responseHeaders): string
    {
        // Implement the operation ...
    }
...
class CrxApi implements CrxApiInterface
{
     ...
     */
    public function postPackageServiceJson(string $path, string $cmd, ?string $groupName, ?string $packageName, ?string $packageVersion, ?string $charset, ?bool $force, ?bool $recursive, ?UploadedFile $package, int &$responseCode, array &$responseHeaders): array|object|null
    {
        // Implement the operation ...
    }
...
class CrxApi implements CrxApiInterface
{
     ...
     */
    public function postPackageUpdate(string $groupName, string $packageName, string $version, string $path, ?string $filter, ?string $charset, int &$responseCode, array &$responseHeaders): array|object|null
    {
        // Implement the operation ...
    }
...
class CrxApi implements CrxApiInterface
{
     ...
     */
    public function postSetPassword(string $old, string $plain, string $verify, int &$responseCode, array &$responseHeaders): string
    {
        // Implement the operation ...
    }
