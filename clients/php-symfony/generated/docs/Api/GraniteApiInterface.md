...
class GraniteApi implements GraniteApiInterface
{
     ...
     */
    public function sslSetup(string $keystorePassword, string $keystorePasswordConfirm, string $truststorePassword, string $truststorePasswordConfirm, string $httpsHostname, string $httpsPort, ?UploadedFile $privatekeyFile, ?UploadedFile $certificateFile, int &$responseCode, array &$responseHeaders): string
    {
