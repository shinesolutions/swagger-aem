...
class CustomApi implements CustomApiInterface
{
     ...
     */
    public function getAemHealthCheck(?string $tags, ?bool $combineTagsOr, int &$responseCode, array &$responseHeaders): array|object|null
    {
...
class CustomApi implements CustomApiInterface
{
     ...
     */
    public function postConfigAemHealthCheckServlet(?array $bundlesIgnored, ?string $bundlesIgnoredTypeHint, int &$responseCode, array &$responseHeaders): void
    {
        // Implement the operation ...
    }
...
class CustomApi implements CustomApiInterface
{
     ...
     */
    public function postConfigAemPasswordReset(?array $pwdresetAuthorizables, ?string $pwdresetAuthorizablesTypeHint, int &$responseCode, array &$responseHeaders): void
    {
        // Implement the operation ...
    }
