...
class SlingApi(baseUrl: String) {
   ...
   * @param name 
   */
  def deleteAgent(username: String, password: String)(runmode: String, name: String
   ...
   * @param name 
   */
  def deleteNode(username: String, password: String)(path: String, name: String
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param name 
   */
  def getAgent(username: String, password: String)(runmode: String, name: String
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param runmode 
   */
  def getAgents(username: String, password: String)(runmode: String
   ...
   */
  def getAuthorizableKeystore(username: String, password: String)(intermediatePath: String, authorizableId: String
): Request[Either[ResponseException[String, Exception], KeystoreInfo], Any] =
    basicRequest
   ...
   * @param authorizableId 
   */
  def getKeystore(username: String, password: String)(intermediatePath: String, authorizableId: String
   ...
   * @param name 
   */
  def getNode(username: String, password: String)(path: String, name: String
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param version 
   */
  def getPackage(username: String, password: String)(group: String, name: String, version: String
): Request[Either[ResponseException[String, Exception], File], Any] =
    basicRequest
   ...
   * @param version 
   */
  def getPackageFilter(username: String, password: String)(group: String, name: String, version: String
): Request[Either[ResponseException[String, Exception], String], Any] =
    basicRequest
   ...
   */
  def getQuery(username: String, password: String)(path: String, pLimit: Double, `1property`: String, `1propertyValue`: String
): Request[Either[ResponseException[String, Exception], String], Any] =
    basicRequest
   ...
   *   aemAuth (http)
   */
  def getTruststore(username: String, password: String)(
): Request[Either[ResponseException[String, Exception], File], Any] =
    basicRequest
   ...
   *   aemAuth (http)
   */
  def getTruststoreInfo(username: String, password: String)(
): Request[Either[ResponseException[String, Exception], TruststoreInfo], Any] =
    basicRequest
...
, 
   ...
   */
  def postAuthorizables(username: String, password: String)(authorizableId: String, intermediatePath: String, createUser: Option[String] = None, createGroup: Option[String] = None, repPassword: Option[String] = None, profileGivenName: Option[String] = None
): Request[Either[ResponseException[String, Exception], String], Any] =
    basicRequest
   ...
   */
  def postConfigApacheSlingDavExServlet(username: String, password: String)(alias: Option[String] = None, aliasTypeHint: Option[String] = None, davCreateAbsoluteUri: Option[Boolean] = None, davCreateAbsoluteUriTypeHint: Option[String] = None
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   */
  def postConfigProperty(username: String, password: String)(configNodeName: String
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param file 
   */
  def postNode(username: String, password: String)(path: String, name: String, operation: Option[String] = None, deleteAuthorizable: Option[String] = None, file: Option[File] = None
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param addMembers 
   */
  def postNodeRw(username: String, password: String)(path: String, name: String, addMembers: Option[String] = None
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param name 
   */
  def postPath(username: String, password: String)(path: String, jcrPrimaryType: String, name: String
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param `1propertyValue` 
   */
  def postQuery(username: String, password: String)(path: String, pLimit: Double, `1property`: String, `1propertyValue`: String
): Request[Either[ResponseException[String, Exception], String], Any] =
    basicRequest
   ...
   * @param cmd 
   */
  def postTreeActivation(username: String, password: String)(ignoredeactivated: Boolean, onlymodified: Boolean, path: String, cmd: String
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param certificate 
   */
  def postTruststore(username: String, password: String)(operation: Option[String] = None, newPassword: Option[String] = None, rePassword: Option[String] = None, keyStoreType: Option[String] = None, removeAlias: Option[String] = None, certificate: Option[File] = None
): Request[Either[ResponseException[String, Exception], String], Any] =
    basicRequest
   ...
   * @param truststoreP12 
   */
  def postTruststorePKCS12(username: String, password: String)(truststoreP12: Option[File] = None
): Request[Either[ResponseException[String, Exception], String], Any] =
    basicRequest
