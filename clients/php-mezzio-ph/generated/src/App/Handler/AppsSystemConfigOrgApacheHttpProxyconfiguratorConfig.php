 ...
 */
class AppsSystemConfigOrgApacheHttpProxyconfiguratorConfig
{
    /**
     * @PHA\Post()
     ...
     */
    public function postConfigApacheHttpComponentsProxyConfiguration(ServerRequestInterface $request)
    {
