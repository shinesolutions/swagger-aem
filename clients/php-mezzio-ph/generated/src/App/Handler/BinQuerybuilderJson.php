...
class BinQuerybuilderJson
{
     ...
     * @return string
     */
    public function getQuery(ServerRequestInterface $request): string
    {
     ...
     * @return string
     */
    public function postQuery(ServerRequestInterface $request): string
    {
        //TODO implement method
