...
additionalProperties:
  packageGuid: '{480698AD-C6B6-4C7E-B704-DF46737BB4B7}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IConsoleApi>();
            IGetAemProductInfoApiResponse apiResponse = await api.GetAemProductInfoAsync("todo");
            List<string>? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Adobe Experience Manager (AEM) API
- appVersion: 3.7.1-pre.0
- appDescription: Swagger AEM is an OpenAPI specification for Adobe Experience Manager (AEM) API
