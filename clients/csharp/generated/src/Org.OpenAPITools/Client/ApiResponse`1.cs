...
namespace Org.OpenAPITools.Client
{
    ...
    /// </summary>
    /// <typeparam name="TType"></typeparam>
    public interface IFound<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is Found
        /// </summary>
        /// <returns></returns>
        TType Found();

        /// <summary>
        /// Returns true if the response is Found and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryFound([NotNullWhen(true)]out TType? result);
    }
