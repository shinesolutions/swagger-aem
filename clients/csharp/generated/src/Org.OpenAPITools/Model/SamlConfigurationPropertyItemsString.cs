...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SamlConfigurationPropertyItemsString :  IEquatable<SamlConfigurationPropertyItemsString>, IValidatableObject
    {
        /// <summary>
        ...
        public SamlConfigurationPropertyItemsString(string name = default(string), bool? optional = default(bool?), bool? isSet = default(bool?), int? type = default(int?), string value = default(string), string description = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as SamlConfigurationPropertyItemsString);
        }

        /// <summary>
        /// Returns true if SamlConfigurationPropertyItemsString instances are equal
        /// </summary>
        /// <param name="input">Instance of SamlConfigurationPropertyItemsString to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SamlConfigurationPropertyItemsString input)
        {
            if (input == null)
                return false;
