...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SamlConfigurationPropertyItemsLong :  IEquatable<SamlConfigurationPropertyItemsLong>, IValidatableObject
    {
        /// <summary>
        ...
        public SamlConfigurationPropertyItemsLong(string name = default(string), bool optional = default(bool), bool isSet = default(bool), int type = default(int), int value = default(int), string description = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as SamlConfigurationPropertyItemsLong);
        }

        /// <summary>
        /// Returns true if SamlConfigurationPropertyItemsLong instances are equal
        /// </summary>
        /// <param name="input">Instance of SamlConfigurationPropertyItemsLong to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SamlConfigurationPropertyItemsLong input)
        {
            if (input == null)
                return false;
