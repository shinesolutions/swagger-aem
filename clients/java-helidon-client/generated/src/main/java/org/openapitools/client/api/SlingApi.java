...
public interface SlingApi  {
    ...
    @Path("/{path}/{name}")
    @Consumes({ "multipart/form-data" })
    void postNode(@PathParam("path") String path, @PathParam("name") String name, @QueryParam(":operation") String operation, @QueryParam("deleteAuthorizable") String deleteAuthorizable, @FormParam("file") File _file) throws ApiException, ProcessingException;
    ...
    @Consumes({ "multipart/form-data" })
    @Produces({ "text/plain" })
    String postTruststore(@QueryParam(":operation") String operation, @QueryParam("newPassword") String newPassword, @QueryParam("rePassword") String rePassword, @QueryParam("keyStoreType") String keyStoreType, @QueryParam("removeAlias") String removeAlias, @FormParam("certificate") File certificate) throws ApiException, ProcessingException;

    @POST
    @Path("/etc/truststore")
    @Consumes({ "multipart/form-data" })
    @Produces({ "text/plain" })
    String postTruststorePKCS12(@FormParam("truststore.p12") File truststoreP12) throws ApiException, ProcessingException;
}
