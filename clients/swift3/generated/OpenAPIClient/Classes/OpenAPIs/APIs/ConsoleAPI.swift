...
open class ConsoleAPI: APIBase {
    /**
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAemProductInfo(completion: @escaping ((_ data: [String]?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getConfigMgr(completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postBundle(name: String, action: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postJmxRepository(action: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
