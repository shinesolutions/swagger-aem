...
open class SlingAPI: APIBase {
    /**
     - parameter runmode: (path)  
     - parameter name: (path)  
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteAgent(runmode: String, name: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteNode(path: String, name: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAgent(runmode: String, name: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAgents(runmode: String, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getAuthorizableKeystore(intermediatePath: String, authorizableId: String, completion: @escaping ((_ data: KeystoreInfo?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getKeystore(intermediatePath: String, authorizableId: String, completion: @escaping ((_ data: URL?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getNode(path: String, name: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPackage(group: String, name: String, version: String, completion: @escaping ((_ data: URL?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getPackageFilter(group: String, name: String, version: String, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getQuery(path: String, pLimit: Double, _1property: String, _1propertyValue: String, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTruststore(completion: @escaping ((_ data: URL?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getTruststoreInfo(completion: @escaping ((_ data: TruststoreInfo?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postAuthorizableKeystore(intermediatePath: String, authorizableId: String, operation: String? = nil, currentPassword: String? = nil, newPassword: String? = nil, rePassword: String? = nil, keyPassword: String? = nil, keyStorePass: String? = nil, alias: String? = nil, newAlias: String? = nil, removeAlias: String? = nil, certChain: URL? = nil, pk: URL? = nil, keyStore: URL? = nil, completion: @escaping ((_ data: KeystoreInfo?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postAuthorizables(authorizableId: String, intermediatePath: String, createUser: String? = nil, createGroup: String? = nil, reppassword: String? = nil, profilegivenName: String? = nil, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postConfigApacheHttpComponentsProxyConfiguration(proxyHost: String? = nil, proxyHostTypeHint: String? = nil, proxyPort: Int32? = nil, proxyPortTypeHint: String? = nil, proxyExceptions: [String]? = nil, proxyExceptionsTypeHint: String? = nil, proxyEnabled: Bool? = nil, proxyEnabledTypeHint: String? = nil, proxyUser: String? = nil, proxyUserTypeHint: String? = nil, proxyPassword: String? = nil, proxyPasswordTypeHint: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func postConfigApacheHttpComponentsProxyConfigurationWithRequestBuilder(proxyHost: String? = nil, proxyHostTypeHint: String? = nil, proxyPort: Int32? = nil, proxyPortTypeHint: String? = nil, proxyExceptions: [String]? = nil, proxyExceptionsTypeHint: String? = nil, proxyEnabled: Bool? = nil, proxyEnabledTypeHint: String? = nil, proxyUser: String? = nil, proxyUserTypeHint: String? = nil, proxyPassword: String? = nil, proxyPasswordTypeHint: String? = nil) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postConfigApacheSlingDavExServlet(alias: String? = nil, aliasTypeHint: String? = nil, davCreateAbsoluteUri: Bool? = nil, davCreateAbsoluteUriTypeHint: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postNode(path: String, name: String, operation: String? = nil, deleteAuthorizable: String? = nil, file: URL? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postNodeRw(path: String, name: String, addMembers: String? = nil, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postPath(path: String, jcrprimaryType: String, name: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postQuery(path: String, pLimit: Double, _1property: String, _1propertyValue: String, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postTreeActivation(ignoredeactivated: Bool, onlymodified: Bool, path: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postTruststore(operation: String? = nil, newPassword: String? = nil, rePassword: String? = nil, keyStoreType: String? = nil, removeAlias: String? = nil, certificate: URL? = nil, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postTruststorePKCS12(truststoreP12: URL? = nil, completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
