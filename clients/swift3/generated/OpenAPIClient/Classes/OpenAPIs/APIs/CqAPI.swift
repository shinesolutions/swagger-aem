...
open class CqAPI: APIBase {
    /**
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getLoginPage(completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postCqActions(authorizableId: String, changelog: String, completion: @escaping ((_ error: ErrorResponse?) -> Void)) {
