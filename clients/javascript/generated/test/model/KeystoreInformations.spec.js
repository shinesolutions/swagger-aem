...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAem.KeystoreInformations();
  });
  ...
  describe('KeystoreInformations', function() {
    it('should create an instance of KeystoreInformations', function() {
      // uncomment below and update the code to test KeystoreInformations
      //var instane = new NodeSwaggerAem.KeystoreInformations();
      //expect(instance).to.be.a(NodeSwaggerAem.KeystoreInformations);
    });
