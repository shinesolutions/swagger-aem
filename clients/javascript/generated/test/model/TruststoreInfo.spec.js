...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeSwaggerAem.TruststoreInfo();
  });
  ...
  describe('TruststoreInfo', function() {
    it('should create an instance of TruststoreInfo', function() {
      // uncomment below and update the code to test TruststoreInfo
      //var instance = new NodeSwaggerAem.TruststoreInfo();
      //expect(instance).to.be.a(NodeSwaggerAem.TruststoreInfo);
    });
