...
class InstallStatus {
    ...
    /**
     * Validates the JSON data with respect to <code>InstallStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstallStatus</code>.
     */
    static validateJSON(data) {
        // validate the optional field `status`
        if (data['status']) { // data not null
          InstallStatusStatus.validateJSON(data['status']);
        }
