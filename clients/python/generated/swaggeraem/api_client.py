...
from swaggeraem.api_response import ApiResponse, T as ApiResponseT
import swaggeraem.models
from swaggeraem import rest
from swaggeraem.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(swaggeraem.models, klass)
