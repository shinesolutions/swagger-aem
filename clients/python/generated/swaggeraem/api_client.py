...
from swaggeraem import rest
from swaggeraem.configuration import Configuration
from swaggeraem.exceptions import ApiTypeError, ApiValueError, ApiException
from swaggeraem.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ConsoleApi()
        api_instance.get_aem_product_info  # this is an instance of the class Endpoint
        api_instance.get_aem_product_info()  # this invokes api_instance.get_aem_product_info.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_aem_product_info.callable or self.callable in this class
