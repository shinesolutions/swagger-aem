...
class CrxApi(object):
    ...
    def get_crxde_status(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_crxde_status_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_package_manager_servlet(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_package_manager_servlet_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def post_package_update_with_http_info(self, group_name, package_name, version, path, **kwargs):  # noqa: E501
        ...
        if ('package_name' not in local_var_params or
                local_var_params['package_name'] is None):
    ...
    def post_set_password_with_http_info(self, old, plain, verify, **kwargs):  # noqa: E501
        ...
        if ('old' not in local_var_params or
                local_var_params['old'] is None):
        ...
        if ('plain' not in local_var_params or
                local_var_params['plain'] is None):
        ...
        if ('verify' not in local_var_params or
                local_var_params['verify'] is None):
