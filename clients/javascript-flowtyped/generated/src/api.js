...
export const CrxApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postPackageServiceJson(path: string, cmd: string, groupName?: string, packageName?: string, packageVersion?: string, charset?: string, force?: boolean, recursive?: boolean, _package?: File, options: RequestOptions): FetchArgs {
...
export type CrxApiType = { 
    ...
    postPackageServiceJson(path: string, cmd: string, groupName?: string, packageName?: string, packageVersion?: string, charset?: string, force?: boolean, recursive?: boolean, _package?: File, options?: RequestOptions): Promise<string>,
...
export const GraniteApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        sslSetup(keystorePassword: string, keystorePasswordConfirm: string, truststorePassword: string, truststorePasswordConfirm: string, httpsHostname: string, httpsPort: string, privatekeyFile?: File, certificateFile?: File, options: RequestOptions): FetchArgs {
...
export type GraniteApiType = { 
    sslSetup(keystorePassword: string, keystorePasswordConfirm: string, truststorePassword: string, truststorePasswordConfirm: string, httpsHostname: string, httpsPort: string, privatekeyFile?: File, certificateFile?: File, options?: RequestOptions): Promise<string>,
}
    ...
    return {
        ...
        postAgent(runmode: string, name: string, jcrContentCqDistribute?: boolean, jcrContentCqDistributeTypeHint?: string, jcrContentCqName?: string, jcrContentCqTemplate?: string, jcrContentAliasUpdate?: boolean, jcrContentEnabled?: boolean, jcrContentJcrDescription?: string, jcrContentJcrLastModified?: string, jcrContentJcrLastModifiedBy?: string, jcrContentJcrMixinTypes?: string, jcrContentJcrTitle?: string, jcrContentLogLevel?: string, jcrContentNoStatusUpdate?: boolean, jcrContentNoVersioning?: boolean, jcrContentProtocolConnectTimeout?: number, jcrContentProtocolHTTPConnectionClosed?: boolean, jcrContentProtocolHTTPExpired?: string, jcrContentProtocolHTTPHeaders?: Array<string>, jcrContentProtocolHTTPHeadersTypeHint?: string, jcrContentProtocolHTTPMethod?: string, jcrContentProtocolHTTPSRelaxed?: boolean, jcrContentProtocolInterface?: string, jcrContentProtocolSocketTimeout?: number, jcrContentProtocolVersion?: string, jcrContentProxyNTLMDomain?: string, jcrContentProxyNTLMHost?: string, jcrContentProxyHost?: string, jcrContentProxyPassword?: string, jcrContentProxyPort?: number, jcrContentProxyUser?: string, jcrContentQueueBatchMaxSize?: number, jcrContentQueueBatchMode?: string, jcrContentQueueBatchWaitTime?: number, jcrContentRetryDelay?: string, jcrContentReverseReplication?: boolean, jcrContentSerializationType?: string, jcrContentSlingResourceType?: string, jcrContentSsl?: string, jcrContentTransportNTLMDomain?: string, jcrContentTransportNTLMHost?: string, jcrContentTransportPassword?: string, jcrContentTransportUri?: string, jcrContentTransportUser?: string, jcrContentTriggerDistribute?: boolean, jcrContentTriggerModified?: boolean, jcrContentTriggerOnOffTime?: boolean, jcrContentTriggerReceive?: boolean, jcrContentTriggerSpecific?: boolean, jcrContentUserId?: string, jcrPrimaryType?: string, operation?: string, options: RequestOptions): FetchArgs {
            ...
            if (jcrContentAliasUpdate !== undefined) {
                localVarQueryParameter['jcr:content/aliasUpdate'] = ((jcrContentAliasUpdate:any):string);
            }
         ...
         * @throws {RequiredError}
         */
        postNode(path: string, name: string, operation?: string, deleteAuthorizable?: string, file?: File, options: RequestOptions): FetchArgs {
            // verify required parameter 'path' is not null or undefined
            if (path === null || path === undefined) {
         ...
         * @throws {RequiredError}
         */
        postTreeActivation(ignoredeactivated: boolean, onlymodified: boolean, path: string, cmd: string, options: RequestOptions): FetchArgs {
            ...
            // verify required parameter 'cmd' is not null or undefined
            if (cmd === null || cmd === undefined) {
                throw new RequiredError('cmd','Required parameter cmd was null or undefined when calling postTreeActivation.');
            }
         ...
         * @throws {RequiredError}
         */
        postTruststore(operation?: string, newPassword?: string, rePassword?: string, keyStoreType?: string, removeAlias?: string, certificate?: File, options: RequestOptions): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        postTruststorePKCS12(truststoreP12?: File, options: RequestOptions): FetchArgs {
...
export type SlingApiType = { 
    ...
    getKeystore(intermediatePath: string, authorizableId: string, options?: RequestOptions): Promise<File>,

    getNode(path: string, name: string, options?: RequestOptions): Promise<Response>,

    getPackage(group: string, name: string, version: string, options?: RequestOptions): Promise<File>,
    ...
    getTruststore(options?: RequestOptions): Promise<File>,
    ...
    postAuthorizableKeystore(intermediatePath: string, authorizableId: string, operation?: string, currentPassword?: string, newPassword?: string, rePassword?: string, keyPassword?: string, keyStorePass?: string, alias?: string, newAlias?: string, removeAlias?: string, certChain?: File, pk?: File, keyStore?: File, options?: RequestOptions): Promise<KeystoreInfo>,
    ...
    postNode(path: string, name: string, operation?: string, deleteAuthorizable?: string, file?: File, options?: RequestOptions): Promise<Response>,
    ...
    postTreeActivation(ignoredeactivated: boolean, onlymodified: boolean, path: string, cmd: string, options?: RequestOptions): Promise<Response>,

    postTruststore(operation?: string, newPassword?: string, rePassword?: string, keyStoreType?: string, removeAlias?: string, certificate?: File, options?: RequestOptions): Promise<string>,

    postTruststorePKCS12(truststoreP12?: File, options?: RequestOptions): Promise<string>,
}
...
export const SlingApi = function(configuration?: Configuration, fetch: FetchAPI = portableFetch): SlingApiType {
    ...
    return {
         ...
         */
        postTreeActivation(ignoredeactivated: boolean, onlymodified: boolean, path: string, cmd: string, options?: RequestOptions = {}): Promise<Response> {
            const localVarFetchArgs = SlingApiFetchParamCreator(configuration).postTreeActivation(ignoredeactivated, onlymodified, path, cmd, options);
            return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                if (response.status >= 200 && response.status < 300) {
                    return response;
                } else {
