...
module CrxApiServiceImplementation =
    ...
    type CrxApiServiceImpl() =
      interface ICrxApiService with
        ...
        member this.GetCrxdeStatus ctx  =
          if true then
        ...
        member this.GetInstallStatus ctx  =
          if true then
        ...
        member this.GetPackageManagerServlet ctx  =
          if true then
        ...
        member this.PostPackageService ctx args =
            let content = "Default response" :> obj :?> string // this cast is obviously wrong, and is only intended to allow generated project to compile   
            PostPackageServiceDefaultStatusCode { content = content }

        member this.PostPackageServiceJson ctx args =
            let content = "Default response" :> obj :?> string // this cast is obviously wrong, and is only intended to allow generated project to compile   
            PostPackageServiceJsonDefaultStatusCode { content = content }

        member this.PostPackageUpdate ctx args =
            let content = "Default response" :> obj :?> string // this cast is obviously wrong, and is only intended to allow generated project to compile   
            PostPackageUpdateDefaultStatusCode { content = content }

        member this.PostSetPassword ctx args =
            let content = "Default response" :> obj :?> string // this cast is obviously wrong, and is only intended to allow generated project to compile   
