...
package body .Clients is
   ...
   Media_List_5 : constant Swagger.Mime_List := (
     1 => Swagger.Mime_Text   );
   Media_List_6 : constant Swagger.Mime_List := (
     1 => Mime_4'Access   );
   Media_List_7 : constant Swagger.Mime_List := (
     1 => Mime_5'Access   );
   ...
   procedure Get_Crxde_Status
      ...
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept (Media_List_6);
   ...
   begin
      ...
      Client.Initialize (Req, Media_List_7);
   ...
   begin
      ...
      URI.Add_Param ("jcr:content/aliasUpdate", Jcr_Content_Slashalias_Update);
   ...
   begin
      ...
      URI.Add_Param ("path", Path);
      URI.Add_Param ("cmd", Cmd);
      URI.Set_Path ("/libs/replication/treeactivation.html");
      Client.Call (Swagger.Clients.POST, URI);
