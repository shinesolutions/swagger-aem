...
defmodule AdobeExperienceManager(AEM)API.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    AdobeExperienceManager(AEM)API.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    AdobeExperienceManager(AEM)API.Deserializer.json_decode(body, module)
  end
end
