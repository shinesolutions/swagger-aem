...
feature -- API Access
	...
	post_agent (runmode: STRING_32; name: STRING_32; jcr_content_cq_distribute: BOOLEAN; jcr_content_cq_distribute_type_hint: STRING_32; jcr_content_cq_name: STRING_32; jcr_content_cq_template: STRING_32; jcr_content_alias_update: BOOLEAN; jcr_content_enabled: BOOLEAN; jcr_content_jcr_description: STRING_32; jcr_content_jcr_last_modified: STRING_32; jcr_content_jcr_last_modified_by: STRING_32; jcr_content_jcr_mixin_types: STRING_32; jcr_content_jcr_title: STRING_32; jcr_content_log_level: STRING_32; jcr_content_no_status_update: BOOLEAN; jcr_content_no_versioning: BOOLEAN; jcr_content_protocol_connect_timeout: REAL_32; jcr_content_protocol_ht_tp_connection_closed: BOOLEAN; jcr_content_protocol_ht_tp_expired: STRING_32; jcr_content_protocol_ht_tp_headers: detachable LIST [STRING_32]; jcr_content_protocol_ht_tp_headers_type_hint: STRING_32; jcr_content_protocol_ht_tp_method: STRING_32; jcr_content_protocol_ht_tp_srelaxed: BOOLEAN; jcr_content_protocol_interface: STRING_32; jcr_content_protocol_socket_timeout: REAL_32; jcr_content_protocol_version: STRING_32; jcr_content_proxy_nt_lm_domain: STRING_32; jcr_content_proxy_nt_lm_host: STRING_32; jcr_content_proxy_host: STRING_32; jcr_content_proxy_password: STRING_32; jcr_content_proxy_port: REAL_32; jcr_content_proxy_user: STRING_32; jcr_content_queue_batch_max_size: REAL_32; jcr_content_queue_batch_mode: STRING_32; jcr_content_queue_batch_wait_time: REAL_32; jcr_content_retry_delay: STRING_32; jcr_content_reverse_replication: BOOLEAN; jcr_content_serialization_type: STRING_32; jcr_content_sling_resource_type: STRING_32; jcr_content_ssl: STRING_32; jcr_content_transport_nt_lm_domain: STRING_32; jcr_content_transport_nt_lm_host: STRING_32; jcr_content_transport_password: STRING_32; jcr_content_transport_uri: STRING_32; jcr_content_transport_user: STRING_32; jcr_content_trigger_distribute: BOOLEAN; jcr_content_trigger_modified: BOOLEAN; jcr_content_trigger_on_off_time: BOOLEAN; jcr_content_trigger_receive: BOOLEAN; jcr_content_trigger_specific: BOOLEAN; jcr_content_user_id: STRING_32; jcr_primary_type: STRING_32; var_operation: STRING_32)
			-- 
			-- 
			-- 
			-- argument: runmode  (required)
			...
			-- argument: name  (required)
			-- 
			-- argument: jcr_content_cq_distribute  (optional, default to null)
			-- 
			-- argument: jcr_content_cq_distribute_type_hint  (optional, default to null)
			-- 
			-- argument: jcr_content_cq_name  (optional, default to null)
			-- 
			-- argument: jcr_content_cq_template  (optional, default to null)
			-- 
			-- argument: jcr_content_alias_update  (optional, default to null)
			-- 
			-- argument: jcr_content_enabled  (optional, default to null)
			-- 
			-- argument: jcr_content_jcr_description  (optional, default to null)
			-- 
			-- argument: jcr_content_jcr_last_modified  (optional, default to null)
			-- 
			-- argument: jcr_content_jcr_last_modified_by  (optional, default to null)
			-- 
			-- argument: jcr_content_jcr_mixin_types  (optional, default to null)
			-- 
			-- argument: jcr_content_jcr_title  (optional, default to null)
			-- 
			-- argument: jcr_content_log_level  (optional, default to null)
			-- 
			-- argument: jcr_content_no_status_update  (optional, default to null)
			-- 
			-- argument: jcr_content_no_versioning  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_connect_timeout  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_ht_tp_connection_closed  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_ht_tp_expired  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_ht_tp_headers  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_ht_tp_headers_type_hint  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_ht_tp_method  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_ht_tp_srelaxed  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_interface  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_socket_timeout  (optional, default to null)
			-- 
			-- argument: jcr_content_protocol_version  (optional, default to null)
			-- 
			-- argument: jcr_content_proxy_nt_lm_domain  (optional, default to null)
			-- 
			-- argument: jcr_content_proxy_nt_lm_host  (optional, default to null)
			-- 
			-- argument: jcr_content_proxy_host  (optional, default to null)
			-- 
			-- argument: jcr_content_proxy_password  (optional, default to null)
			-- 
			-- argument: jcr_content_proxy_port  (optional, default to null)
			-- 
			-- argument: jcr_content_proxy_user  (optional, default to null)
			-- 
			-- argument: jcr_content_queue_batch_max_size  (optional, default to null)
			-- 
			-- argument: jcr_content_queue_batch_mode  (optional, default to null)
			-- 
			-- argument: jcr_content_queue_batch_wait_time  (optional, default to null)
			-- 
			-- argument: jcr_content_retry_delay  (optional, default to null)
			-- 
			-- argument: jcr_content_reverse_replication  (optional, default to null)
			-- 
			-- argument: jcr_content_serialization_type  (optional, default to null)
			-- 
			-- argument: jcr_content_sling_resource_type  (optional, default to null)
			-- 
			-- argument: jcr_content_ssl  (optional, default to null)
			-- 
			-- argument: jcr_content_transport_nt_lm_domain  (optional, default to null)
			-- 
			-- argument: jcr_content_transport_nt_lm_host  (optional, default to null)
			-- 
			-- argument: jcr_content_transport_password  (optional, default to null)
			-- 
			-- argument: jcr_content_transport_uri  (optional, default to null)
			-- 
			-- argument: jcr_content_transport_user  (optional, default to null)
			-- 
			-- argument: jcr_content_trigger_distribute  (optional, default to null)
			-- 
			-- argument: jcr_content_trigger_modified  (optional, default to null)
			-- 
			-- argument: jcr_content_trigger_on_off_time  (optional, default to null)
			-- 
			-- argument: jcr_content_trigger_receive  (optional, default to null)
			-- 
			-- argument: jcr_content_trigger_specific  (optional, default to null)
			-- 
			-- argument: jcr_content_user_id  (optional, default to null)
			-- 
			-- argument: jcr_primary_type  (optional, default to null)
			-- 
			-- argument: var_operation  (optional, default to null)
			-- 
			-- 
		require
		local
		...
		do
			...
			l_path.replace_substring_all ("{"+"runmode"+"}", api_client.url_encode (runmode.out))
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/cq:distribute", jcr_content_cq_distribute));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/cq:distribute@TypeHint", jcr_content_cq_distribute_type_hint));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/cq:name", jcr_content_cq_name));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/cq:template", jcr_content_cq_template));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/aliasUpdate", jcr_content_alias_update));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/enabled", jcr_content_enabled));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/jcr:description", jcr_content_jcr_description));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/jcr:lastModified", jcr_content_jcr_last_modified));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/jcr:lastModifiedBy", jcr_content_jcr_last_modified_by));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/jcr:mixinTypes", jcr_content_jcr_mixin_types));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/jcr:title", jcr_content_jcr_title));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/logLevel", jcr_content_log_level));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/noStatusUpdate", jcr_content_no_status_update));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/noVersioning", jcr_content_no_versioning));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolConnectTimeout", jcr_content_protocol_connect_timeout));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolHTTPConnectionClosed", jcr_content_protocol_ht_tp_connection_closed));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolHTTPExpired", jcr_content_protocol_ht_tp_expired));
			l_request.fill_query_params(api_client.parameter_to_tuple("multi", "jcr:content/protocolHTTPHeaders", jcr_content_protocol_ht_tp_headers));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolHTTPHeaders@TypeHint", jcr_content_protocol_ht_tp_headers_type_hint));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolHTTPMethod", jcr_content_protocol_ht_tp_method));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolHTTPSRelaxed", jcr_content_protocol_ht_tp_srelaxed));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolInterface", jcr_content_protocol_interface));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolSocketTimeout", jcr_content_protocol_socket_timeout));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/protocolVersion", jcr_content_protocol_version));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/proxyNTLMDomain", jcr_content_proxy_nt_lm_domain));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/proxyNTLMHost", jcr_content_proxy_nt_lm_host));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/proxyHost", jcr_content_proxy_host));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/proxyPassword", jcr_content_proxy_password));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/proxyPort", jcr_content_proxy_port));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/proxyUser", jcr_content_proxy_user));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/queueBatchMaxSize", jcr_content_queue_batch_max_size));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/queueBatchMode", jcr_content_queue_batch_mode));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/queueBatchWaitTime", jcr_content_queue_batch_wait_time));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/retryDelay", jcr_content_retry_delay));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/reverseReplication", jcr_content_reverse_replication));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/serializationType", jcr_content_serialization_type));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/sling:resourceType", jcr_content_sling_resource_type));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/ssl", jcr_content_ssl));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/transportNTLMDomain", jcr_content_transport_nt_lm_domain));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/transportNTLMHost", jcr_content_transport_nt_lm_host));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/transportPassword", jcr_content_transport_password));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/transportUri", jcr_content_transport_uri));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/transportUser", jcr_content_transport_user));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/triggerDistribute", jcr_content_trigger_distribute));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/triggerModified", jcr_content_trigger_modified));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/triggerOnOffTime", jcr_content_trigger_on_off_time));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/triggerReceive", jcr_content_trigger_receive));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/triggerSpecific", jcr_content_trigger_specific));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:content/userId", jcr_content_user_id));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:primaryType", jcr_primary_type));
			l_request.fill_query_params(api_client.parameter_to_tuple("", ":operation", var_operation));
	...
	post_authorizables (authorizable_id: STRING_32; intermediate_path: STRING_32; create_user: STRING_32; create_group: STRING_32; rep_password: STRING_32; profile_given_name: STRING_32): detachable STRING_32
			-- 
			-- 
			-- 
			-- argument: authorizable_id  (required)
			...
			-- 
			-- argument: rep_password  (optional, default to null)
			-- 
		...
		do
			...
			l_request.fill_query_params(api_client.parameter_to_tuple("", "rep:password", rep_password));
	...
	post_node (path: STRING_32; name: STRING_32; var_operation: STRING_32; delete_authorizable: STRING_32; file: FILE)
			-- 
			-- 
			-- 
			-- argument: path  (required)
	...
	post_path (path: STRING_32; jcr_primary_type: STRING_32; var_name: STRING_32)
			...
			-- argument: path  (required)
			-- 
			-- argument: jcr_primary_type  (required)
			-- 
			-- argument: var_name  (required)
			-- 
			-- 
		require
		local
		...
		do
			...
			l_path.replace_substring_all ("{"+"path"+"}", api_client.url_encode (path.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "jcr:primaryType", jcr_primary_type));
			l_request.fill_query_params(api_client.parameter_to_tuple("", ":name", var_name));
	...
	post_tree_activation (ignoredeactivated: BOOLEAN; onlymodified: BOOLEAN; path: STRING_32; cmd: STRING_32)
		...
		do
			...
			l_path := "/libs/replication/treeactivation.html"
	...
	post_truststore (var_operation: STRING_32; new_password: STRING_32; re_password: STRING_32; key_store_type: STRING_32; remove_alias: STRING_32; certificate: FILE): detachable STRING_32
			-- 
			-- 
			-- 
			-- argument: var_operation  (optional, default to null)
