...
module SwaggerAemClient
  class CrxApi
    ...
    def get_crxde_status_with_http_info(opts = {})
      ...
      header_params['Accept'] = @api_client.select_header_accept(['plain/text']) unless header_params['Accept']
      ...
      new_options = opts.merge(
        :operation => :"CrxApi.get_crxde_status",
    ...
    def get_install_status_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InstallStatus'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['aemAuth']

      new_options = opts.merge(
        :operation => :"CrxApi.get_install_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_package_manager_servlet_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CrxApi.get_package_manager_servlet",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_package_service_with_http_info(cmd, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CrxApi.post_package_service",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_package_service_json_with_http_info(path, cmd, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CrxApi.post_package_service_json",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_package_update_with_http_info(group_name, package_name, version, path, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CrxApi.post_package_update",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_set_password_with_http_info(old, plain, verify, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CrxApi.post_set_password",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
