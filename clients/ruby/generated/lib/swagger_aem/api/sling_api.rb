  ...
  class SlingApi
    ...
    def delete_agent_with_http_info(runmode, name, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.delete_agent",
    ...
    def delete_node_with_http_info(path, name, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.delete_node",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_authorizable_keystore_with_http_info(intermediate_path, authorizable_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'KeystoreInfo'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['aemAuth']

      new_options = opts.merge(
        :operation => :"SlingApi.get_authorizable_keystore",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_keystore_with_http_info(intermediate_path, authorizable_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.get_keystore",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_package_with_http_info(group, name, version, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.get_package",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_package_filter_with_http_info(group, name, version, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.get_package_filter",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_truststore_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.get_truststore",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_truststore_info_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TruststoreInfo'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['aemAuth']

      new_options = opts.merge(
        :operation => :"SlingApi.get_truststore_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param name [String] 
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :jcr_content_cq_distribute 
    # @option opts [String] :jcr_content_cq_distribute_type_hint 
    # @option opts [String] :jcr_content_cq_name 
    # @option opts [String] :jcr_content_cq_template 
    # @option opts [Boolean] :jcr_content_alias_update 
    # @option opts [Boolean] :jcr_content_enabled 
    # @option opts [String] :jcr_content_jcr_description 
    # @option opts [String] :jcr_content_jcr_last_modified 
    # @option opts [String] :jcr_content_jcr_last_modified_by 
    # @option opts [String] :jcr_content_jcr_mixin_types 
    # @option opts [String] :jcr_content_jcr_title 
    # @option opts [String] :jcr_content_log_level 
    # @option opts [Boolean] :jcr_content_no_status_update 
    # @option opts [Boolean] :jcr_content_no_versioning 
    # @option opts [Float] :jcr_content_protocol_connect_timeout 
    # @option opts [Boolean] :jcr_content_protocol_http_connection_closed 
    # @option opts [String] :jcr_content_protocol_http_expired 
    # @option opts [Array<String>] :jcr_content_protocol_http_headers 
    # @option opts [String] :jcr_content_protocol_http_headers_type_hint 
    # @option opts [String] :jcr_content_protocol_http_method 
    # @option opts [Boolean] :jcr_content_protocol_https_relaxed 
    # @option opts [String] :jcr_content_protocol_interface 
    # @option opts [Float] :jcr_content_protocol_socket_timeout 
    # @option opts [String] :jcr_content_protocol_version 
    # @option opts [String] :jcr_content_proxy_ntlm_domain 
    # @option opts [String] :jcr_content_proxy_ntlm_host 
    # @option opts [String] :jcr_content_proxy_host 
    # @option opts [String] :jcr_content_proxy_password 
    # @option opts [Float] :jcr_content_proxy_port 
    # @option opts [String] :jcr_content_proxy_user 
    # @option opts [Float] :jcr_content_queue_batch_max_size 
    # @option opts [String] :jcr_content_queue_batch_mode 
    # @option opts [Float] :jcr_content_queue_batch_wait_time 
    # @option opts [String] :jcr_content_retry_delay 
    # @option opts [Boolean] :jcr_content_reverse_replication 
    # @option opts [String] :jcr_content_serialization_type 
    # @option opts [String] :jcr_content_sling_resource_type 
    # @option opts [String] :jcr_content_ssl 
    # @option opts [String] :jcr_content_transport_ntlm_domain 
    # @option opts [String] :jcr_content_transport_ntlm_host 
    # @option opts [String] :jcr_content_transport_password 
    # @option opts [String] :jcr_content_transport_uri 
    # @option opts [String] :jcr_content_transport_user 
    # @option opts [Boolean] :jcr_content_trigger_distribute 
    # @option opts [Boolean] :jcr_content_trigger_modified 
    # @option opts [Boolean] :jcr_content_trigger_on_off_time 
    # @option opts [Boolean] :jcr_content_trigger_receive 
    # @option opts [Boolean] :jcr_content_trigger_specific 
    # @option opts [String] :jcr_content_user_id 
    # @option opts [String] :jcr_primary_type 
    # @option opts [String] :_operation 
    # @return [nil]
    ...
    def post_agent_with_http_info(runmode, name, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'jcr:content/cq:distribute'] = opts[:'jcr_content_cq_distribute'] if !opts[:'jcr_content_cq_distribute'].nil?
      query_params[:'jcr:content/cq:distribute@TypeHint'] = opts[:'jcr_content_cq_distribute_type_hint'] if !opts[:'jcr_content_cq_distribute_type_hint'].nil?
      query_params[:'jcr:content/cq:name'] = opts[:'jcr_content_cq_name'] if !opts[:'jcr_content_cq_name'].nil?
      query_params[:'jcr:content/cq:template'] = opts[:'jcr_content_cq_template'] if !opts[:'jcr_content_cq_template'].nil?
      query_params[:'jcr:content/aliasUpdate'] = opts[:'jcr_content_alias_update'] if !opts[:'jcr_content_alias_update'].nil?
      query_params[:'jcr:content/enabled'] = opts[:'jcr_content_enabled'] if !opts[:'jcr_content_enabled'].nil?
      query_params[:'jcr:content/jcr:description'] = opts[:'jcr_content_jcr_description'] if !opts[:'jcr_content_jcr_description'].nil?
      query_params[:'jcr:content/jcr:lastModified'] = opts[:'jcr_content_jcr_last_modified'] if !opts[:'jcr_content_jcr_last_modified'].nil?
      query_params[:'jcr:content/jcr:lastModifiedBy'] = opts[:'jcr_content_jcr_last_modified_by'] if !opts[:'jcr_content_jcr_last_modified_by'].nil?
      query_params[:'jcr:content/jcr:mixinTypes'] = opts[:'jcr_content_jcr_mixin_types'] if !opts[:'jcr_content_jcr_mixin_types'].nil?
      query_params[:'jcr:content/jcr:title'] = opts[:'jcr_content_jcr_title'] if !opts[:'jcr_content_jcr_title'].nil?
      query_params[:'jcr:content/logLevel'] = opts[:'jcr_content_log_level'] if !opts[:'jcr_content_log_level'].nil?
      query_params[:'jcr:content/noStatusUpdate'] = opts[:'jcr_content_no_status_update'] if !opts[:'jcr_content_no_status_update'].nil?
      query_params[:'jcr:content/noVersioning'] = opts[:'jcr_content_no_versioning'] if !opts[:'jcr_content_no_versioning'].nil?
      query_params[:'jcr:content/protocolConnectTimeout'] = opts[:'jcr_content_protocol_connect_timeout'] if !opts[:'jcr_content_protocol_connect_timeout'].nil?
      query_params[:'jcr:content/protocolHTTPConnectionClosed'] = opts[:'jcr_content_protocol_http_connection_closed'] if !opts[:'jcr_content_protocol_http_connection_closed'].nil?
      query_params[:'jcr:content/protocolHTTPExpired'] = opts[:'jcr_content_protocol_http_expired'] if !opts[:'jcr_content_protocol_http_expired'].nil?
      query_params[:'jcr:content/protocolHTTPHeaders'] = @api_client.build_collection_param(opts[:'jcr_content_protocol_http_headers'], :multi) if !opts[:'jcr_content_protocol_http_headers'].nil?
      query_params[:'jcr:content/protocolHTTPHeaders@TypeHint'] = opts[:'jcr_content_protocol_http_headers_type_hint'] if !opts[:'jcr_content_protocol_http_headers_type_hint'].nil?
      query_params[:'jcr:content/protocolHTTPMethod'] = opts[:'jcr_content_protocol_http_method'] if !opts[:'jcr_content_protocol_http_method'].nil?
      query_params[:'jcr:content/protocolHTTPSRelaxed'] = opts[:'jcr_content_protocol_https_relaxed'] if !opts[:'jcr_content_protocol_https_relaxed'].nil?
      query_params[:'jcr:content/protocolInterface'] = opts[:'jcr_content_protocol_interface'] if !opts[:'jcr_content_protocol_interface'].nil?
      query_params[:'jcr:content/protocolSocketTimeout'] = opts[:'jcr_content_protocol_socket_timeout'] if !opts[:'jcr_content_protocol_socket_timeout'].nil?
      query_params[:'jcr:content/protocolVersion'] = opts[:'jcr_content_protocol_version'] if !opts[:'jcr_content_protocol_version'].nil?
      query_params[:'jcr:content/proxyNTLMDomain'] = opts[:'jcr_content_proxy_ntlm_domain'] if !opts[:'jcr_content_proxy_ntlm_domain'].nil?
      query_params[:'jcr:content/proxyNTLMHost'] = opts[:'jcr_content_proxy_ntlm_host'] if !opts[:'jcr_content_proxy_ntlm_host'].nil?
      query_params[:'jcr:content/proxyHost'] = opts[:'jcr_content_proxy_host'] if !opts[:'jcr_content_proxy_host'].nil?
      query_params[:'jcr:content/proxyPassword'] = opts[:'jcr_content_proxy_password'] if !opts[:'jcr_content_proxy_password'].nil?
      query_params[:'jcr:content/proxyPort'] = opts[:'jcr_content_proxy_port'] if !opts[:'jcr_content_proxy_port'].nil?
      query_params[:'jcr:content/proxyUser'] = opts[:'jcr_content_proxy_user'] if !opts[:'jcr_content_proxy_user'].nil?
      query_params[:'jcr:content/queueBatchMaxSize'] = opts[:'jcr_content_queue_batch_max_size'] if !opts[:'jcr_content_queue_batch_max_size'].nil?
      query_params[:'jcr:content/queueBatchMode'] = opts[:'jcr_content_queue_batch_mode'] if !opts[:'jcr_content_queue_batch_mode'].nil?
      query_params[:'jcr:content/queueBatchWaitTime'] = opts[:'jcr_content_queue_batch_wait_time'] if !opts[:'jcr_content_queue_batch_wait_time'].nil?
      query_params[:'jcr:content/retryDelay'] = opts[:'jcr_content_retry_delay'] if !opts[:'jcr_content_retry_delay'].nil?
      query_params[:'jcr:content/reverseReplication'] = opts[:'jcr_content_reverse_replication'] if !opts[:'jcr_content_reverse_replication'].nil?
      query_params[:'jcr:content/serializationType'] = opts[:'jcr_content_serialization_type'] if !opts[:'jcr_content_serialization_type'].nil?
      query_params[:'jcr:content/sling:resourceType'] = opts[:'jcr_content_sling_resource_type'] if !opts[:'jcr_content_sling_resource_type'].nil?
      query_params[:'jcr:content/ssl'] = opts[:'jcr_content_ssl'] if !opts[:'jcr_content_ssl'].nil?
      query_params[:'jcr:content/transportNTLMDomain'] = opts[:'jcr_content_transport_ntlm_domain'] if !opts[:'jcr_content_transport_ntlm_domain'].nil?
      query_params[:'jcr:content/transportNTLMHost'] = opts[:'jcr_content_transport_ntlm_host'] if !opts[:'jcr_content_transport_ntlm_host'].nil?
      query_params[:'jcr:content/transportPassword'] = opts[:'jcr_content_transport_password'] if !opts[:'jcr_content_transport_password'].nil?
      query_params[:'jcr:content/transportUri'] = opts[:'jcr_content_transport_uri'] if !opts[:'jcr_content_transport_uri'].nil?
      query_params[:'jcr:content/transportUser'] = opts[:'jcr_content_transport_user'] if !opts[:'jcr_content_transport_user'].nil?
      query_params[:'jcr:content/triggerDistribute'] = opts[:'jcr_content_trigger_distribute'] if !opts[:'jcr_content_trigger_distribute'].nil?
      query_params[:'jcr:content/triggerModified'] = opts[:'jcr_content_trigger_modified'] if !opts[:'jcr_content_trigger_modified'].nil?
      query_params[:'jcr:content/triggerOnOffTime'] = opts[:'jcr_content_trigger_on_off_time'] if !opts[:'jcr_content_trigger_on_off_time'].nil?
      query_params[:'jcr:content/triggerReceive'] = opts[:'jcr_content_trigger_receive'] if !opts[:'jcr_content_trigger_receive'].nil?
      query_params[:'jcr:content/triggerSpecific'] = opts[:'jcr_content_trigger_specific'] if !opts[:'jcr_content_trigger_specific'].nil?
      query_params[:'jcr:content/userId'] = opts[:'jcr_content_user_id'] if !opts[:'jcr_content_user_id'].nil?
      query_params[:'jcr:primaryType'] = opts[:'jcr_primary_type'] if !opts[:'jcr_primary_type'].nil?
      query_params[:':operation'] = opts[:'_operation'] if !opts[:'_operation'].nil?
    ...
    def post_authorizable_keystore_with_http_info(intermediate_path, authorizable_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_authorizable_keystore",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @option opts [String] :rep_password 
    ...
    def post_authorizables_with_http_info(authorizable_id, intermediate_path, opts = {})
      ...
      query_params[:'rep:password'] = opts[:'rep_password'] if !opts[:'rep_password'].nil?
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_authorizables",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_config_adobe_granite_saml_authentication_handler_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_config_adobe_granite_saml_authentication_handler",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_config_apache_felix_jetty_based_http_service_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_config_apache_felix_jetty_based_http_service",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_config_apache_http_components_proxy_configuration_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_config_apache_http_components_proxy_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_config_apache_sling_dav_ex_servlet_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_config_apache_sling_dav_ex_servlet",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_config_apache_sling_get_servlet_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_config_apache_sling_get_servlet",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_config_apache_sling_referrer_filter_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_config_apache_sling_referrer_filter",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_config_property_with_http_info(config_node_name, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_config_property",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_node_rw_with_http_info(path, name, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_node_rw",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    # @param path [String] 
    # @param jcr_primary_type [String] 
    # @param _name [String] 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def post_path(path, jcr_primary_type, _name, opts = {})
      post_path_with_http_info(path, jcr_primary_type, _name, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def post_path_with_http_info(path, jcr_primary_type, _name, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && jcr_primary_type.nil?
        fail ArgumentError, "Missing the required parameter 'jcr_primary_type' when calling SlingApi.post_path"
      end
      # verify the required parameter '_name' is set
      if @api_client.config.client_side_validation && _name.nil?
        fail ArgumentError, "Missing the required parameter '_name' when calling SlingApi.post_path"
      end
      # resource path
    ...
    def post_tree_activation_with_http_info(ignoredeactivated, onlymodified, path, cmd, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_tree_activation",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_truststore_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_truststore",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_truststore_pkcs12_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SlingApi.post_truststore_pkcs12",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
