  ...
  class ConsoleApi
    ...
    def get_aem_product_info_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ConsoleApi.get_aem_product_info",
    ...
    def get_bundle_info_with_http_info(name, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BundleInfo'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['aemAuth']

      new_options = opts.merge(
        :operation => :"ConsoleApi.get_bundle_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_config_mgr_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ConsoleApi.get_config_mgr",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_bundle_with_http_info(name, action, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ConsoleApi.post_bundle",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_jmx_repository_with_http_info(action, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"ConsoleApi.post_jmx_repository",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_saml_configuration_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SamlConfigurationInfo'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['aemAuth']

      new_options = opts.merge(
        :operation => :"ConsoleApi.post_saml_configuration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
