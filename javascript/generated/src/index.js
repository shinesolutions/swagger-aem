...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'api/ConsoleApi', 'api/CqApi', 'api/CrxApi', 'api/CustomApi', 'api/SlingApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./api/ConsoleApi'), require('./api/CqApi'), require('./api/CrxApi'), require('./api/CustomApi'), require('./api/SlingApi'));
  }
}(function(ApiClient, ConsoleApi, CqApi, CrxApi, CustomApi, SlingApi) {
  'use strict';
