...
export default class ConsoleApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/SamlConfigurationInformations} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.serviceRanking 
     ...
     * @param {String} opts.clockTolerance 
     ...
     * data is of type: {@link module:model/SamlConfigurationInformations}
     */
    postSamlConfiguration(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['text/plain'];
      let returnType = SamlConfigurationInformations;
