  ...
  var exports = function(apiClient) {
    ...
    this.postPackageService = function(cmd, callback) {
      ...
      if (cmd == undefined || cmd == null) {
        throw "Missing the required parameter 'cmd' when calling postPackageService";
      }
    ...
    this.postPackageServiceJson = function(path, cmd, opts, callback) {
      ...
      if (path == undefined || path == null) {
        throw "Missing the required parameter 'path' when calling postPackageServiceJson";
      }

      // verify the required parameter 'cmd' is set
      if (cmd == undefined || cmd == null) {
        throw "Missing the required parameter 'cmd' when calling postPackageServiceJson";
      }
    ...
    this.postPackageUpdate = function(groupName, packageName, version, path, opts, callback) {
      ...
      if (groupName == undefined || groupName == null) {
        throw "Missing the required parameter 'groupName' when calling postPackageUpdate";
      }

      // verify the required parameter 'packageName' is set
      if (packageName == undefined || packageName == null) {
        throw "Missing the required parameter 'packageName' when calling postPackageUpdate";
      }

      // verify the required parameter 'version' is set
      if (version == undefined || version == null) {
        throw "Missing the required parameter 'version' when calling postPackageUpdate";
      }

      // verify the required parameter 'path' is set
      if (path == undefined || path == null) {
        throw "Missing the required parameter 'path' when calling postPackageUpdate";
      }
    ...
    this.postSetPassword = function(old, plain, verify, callback) {
      ...
      if (old == undefined || old == null) {
        throw "Missing the required parameter 'old' when calling postSetPassword";
      }

      // verify the required parameter 'plain' is set
      if (plain == undefined || plain == null) {
        throw "Missing the required parameter 'plain' when calling postSetPassword";
      }

      // verify the required parameter 'verify' is set
      if (verify == undefined || verify == null) {
        throw "Missing the required parameter 'verify' when calling postSetPassword";
      }
