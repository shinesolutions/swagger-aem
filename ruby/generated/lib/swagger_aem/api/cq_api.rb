...
module SwaggerAemClient
  class CqApi
    ...
    def post_cq_actions_with_http_info(authorizable_id, changelog, opts = {})
      ...
      fail "Missing the required parameter 'authorizable_id' when calling post_cq_actions" if authorizable_id.nil?

      # verify the required parameter 'changelog' is set
      fail "Missing the required parameter 'changelog' when calling post_cq_actions" if changelog.nil?
