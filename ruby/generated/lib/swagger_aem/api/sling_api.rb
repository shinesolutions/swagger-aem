...
module SwaggerAemClient
  class SlingApi
    ...
    # @param authorizable_id 
    # @param [Hash] opts the optional parameters
    # @return [Array<(KeystoreInformations, Fixnum, Hash)>] KeystoreInformations data, response status code and response headers
    def get_authorizable_keystore_with_http_info(intermediate_path, authorizable_id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'KeystoreInformations')
      if @api_client.config.debugging
    ...
    def get_truststore_informations(opts = {})
      data, _status_code, _headers = get_truststore_informations_with_http_info(opts)
      return data
    end
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @return [Array<(TruststoreInformations, Fixnum, Hash)>] TruststoreInformations data, response status code and response headers
    def get_truststore_informations_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SlingApi.get_truststore_informations ..."
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'TruststoreInformations')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SlingApi#get_truststore_informations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def post_authorizable_keystore_with_http_info(intermediate_path, authorizable_id, opts = {})
      ...
      query_params[:':operation'] = opts[:'operation2'] if !opts[:'operation2'].nil?
