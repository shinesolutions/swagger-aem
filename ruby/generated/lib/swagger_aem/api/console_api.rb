...
module SwaggerAemClient
  class ConsoleApi
    ...
    # @option opts [String] :service_ranking 
    ...
    # @option opts [String] :clock_tolerance 
    ...
    # @option opts [String] :user_intermediate_path 
    # @option opts [Array<String>] :propertylist 
    # @return [Array<(SamlConfigurationInformations, Fixnum, Hash)>] SamlConfigurationInformations data, response status code and response headers
    def post_saml_configuration_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'SamlConfigurationInformations')
      if @api_client.config.debugging
