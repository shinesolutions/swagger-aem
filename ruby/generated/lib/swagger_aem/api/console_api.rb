...
module SwaggerAemClient
  class ConsoleApi
    ...
    def post_bundle_with_http_info(name, action, opts = {})
      ...
      fail "Missing the required parameter 'name' when calling post_bundle" if name.nil?
      
      # verify the required parameter 'action' is set
      fail "Missing the required parameter 'action' when calling post_bundle" if action.nil?
    ...
    def post_jmx_repository_with_http_info(action, opts = {})
      ...
      # verify the required parameter 'action' is set
      fail "Missing the required parameter 'action' when calling post_jmx_repository" if action.nil?
