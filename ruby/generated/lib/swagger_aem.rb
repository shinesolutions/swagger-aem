...
require 'swagger_aem/models/keystore_informations'
require 'swagger_aem/models/keystore_items'
require 'swagger_aem/models/saml_configuration_informations'
...
require 'swagger_aem/models/truststore_informations'
