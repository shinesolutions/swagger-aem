...
describe SwaggerAemClient::ApiClient do
  ...
  describe "#update_params_for_auth!" do
    it "sets header api-key parameter with prefix" do
      ...
      config2 = SwaggerAemClient::Configuration.new do |c|
        c.api_key_prefix['api_key'] = 'PREFIX2'
        c.api_key['api_key'] = 'special-key2'
      end
      api_client2 = SwaggerAemClient::ApiClient.new(config2)
  ...
  describe "#deserialize" do
    ...
    it "handles Hash<String, Pet>" do
      ...
      pet = data[:pet]
      expect(pet).to be_instance_of(SwaggerAemClient::Pet)
