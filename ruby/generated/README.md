...
- API version: 1.0
- Package version: 0.9.2-pre
- Build date: 2016-09-04T22:00:02.880+10:00
...
```shell
gem install ./swagger_aem-0.9.2-pre.gem
```
(for development, run `gem install --dev ./swagger_aem-0.9.2-pre.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'swagger_aem', '~> 0.9.2-pre'
