...
class CustomApi(object):
    ...
    def get_aem_health_check_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'combine_tags_or' in params:
            query_params.append(('combineTagsOr', params['combine_tags_or']))  # noqa: E501
    ...
    def post_config_aem_health_check_servlet(self, runmode, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.post_config_aem_health_check_servlet_with_http_info(runmode, **kwargs)  # noqa: E501
        else:
            (data) = self.post_config_aem_health_check_servlet_with_http_info(runmode, **kwargs)  # noqa: E501
            return data

    def post_config_aem_health_check_servlet_with_http_info(self, runmode, **kwargs):  # noqa: E501
        """post_config_aem_health_check_servlet  # noqa: E501
        ...
        all_params = ['runmode', 'bundles_ignored', 'bundles_ignored_type_hint']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('runmode' not in params or
            ...
            raise ValueError("Missing the required parameter `runmode` when calling `post_config_aem_health_check_servlet`")  # noqa: E501
        ...
        if 'bundles_ignored' in params:
            query_params.append(('bundles.ignored', params['bundles_ignored']))  # noqa: E501
            collection_formats['bundles.ignored'] = 'multi'  # noqa: E501
        if 'bundles_ignored_type_hint' in params:
            query_params.append(('bundles.ignored@TypeHint', params['bundles_ignored_type_hint']))  # noqa: E501
    ...
    def post_config_aem_password_reset(self, runmode, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.post_config_aem_password_reset_with_http_info(runmode, **kwargs)  # noqa: E501
        else:
            (data) = self.post_config_aem_password_reset_with_http_info(runmode, **kwargs)  # noqa: E501
            return data

    def post_config_aem_password_reset_with_http_info(self, runmode, **kwargs):  # noqa: E501
        """post_config_aem_password_reset  # noqa: E501
        ...
        all_params = ['runmode', 'pwdreset_authorizables', 'pwdreset_authorizables_type_hint']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('runmode' not in params or
                params['runmode'] is None):
            raise ValueError("Missing the required parameter `runmode` when calling `post_config_aem_password_reset`")  # noqa: E501
        ...
        if 'pwdreset_authorizables' in params:
            query_params.append(('pwdreset.authorizables', params['pwdreset_authorizables']))  # noqa: E501
            collection_formats['pwdreset.authorizables'] = 'multi'  # noqa: E501
        if 'pwdreset_authorizables_type_hint' in params:
            query_params.append(('pwdreset.authorizables@TypeHint', params['pwdreset_authorizables_type_hint']))  # noqa: E501
