...
class CustomApi(object):
    ...
    def get_aem_health_check(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_aem_health_check(callback=callback_function)
    ...
    def get_aem_health_check_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_aem_health_check_with_http_info(callback=callback_function)
    ...
    def post_config_aem_health_check_servlet(self, runmode, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_config_aem_health_check_servlet(runmode, callback=callback_function)
    ...
    def post_config_aem_health_check_servlet_with_http_info(self, runmode, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_config_aem_health_check_servlet_with_http_info(runmode, callback=callback_function)
        ...
        return self.api_client.call_api('/apps/system/config.{runmode}/com.shinesolutions.healthcheck.hc.impl.ActiveBundleHealthCheck', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def post_config_aem_password_reset(self, runmode, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_config_aem_password_reset(runmode, callback=callback_function)
    ...
    def post_config_aem_password_reset_with_http_info(self, runmode, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.post_config_aem_password_reset_with_http_info(runmode, callback=callback_function)
        ...
        return self.api_client.call_api('/apps/system/config.{runmode}/com.shinesolutions.aem.passwordreset.Activator', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
