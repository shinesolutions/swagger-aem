...
class CrxApi(object):
    ...
    def post_package_service_with_http_info(self, cmd, **kwargs):
        ...
        resource_path = '/crx/packmgr/service.jsp'.replace('{format}', 'json')
        path_params = {}
    ...
    def post_package_service_json_with_http_info(self, path, cmd, **kwargs):
        ...
        all_params = ['path', 'cmd', 'group_name', 'package_name', 'package_version', 'charset_', 'force', 'package']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        resource_path = '/crx/packmgr/service/.json/{path}'.replace('{format}', 'json')
        path_params = {}
        if 'path' in params:
        ...
        if 'package_name' in params:
            query_params['packageName'] = params['package_name']
        if 'package_version' in params:
            query_params['packageVersion'] = params['package_version']
        if 'charset_' in params:
            query_params['_charset_'] = params['charset_']
        if 'force' in params:
    ...
    def post_package_update_with_http_info(self, group_name, package_name, version, path, **kwargs):
        ...
        resource_path = '/crx/packmgr/update.jsp'.replace('{format}', 'json')
        path_params = {}
    ...
    def post_set_password_with_http_info(self, old, plain, verify, **kwargs):
        ...
        resource_path = '/crx/explorer/ui/setpassword.jsp'.replace('{format}', 'json')
        path_params = {}

        query_params = {}
        if 'old' in params:
            query_params['old'] = params['old']
        if 'plain' in params:
            query_params['plain'] = params['plain']
        if 'verify' in params:
            query_params['verify'] = params['verify']
