...
class SlingApi(object):
    ...
    def post_agent_with_http_info(self, runmode, name, **kwargs):
        ...
        if 'jcrcontenttransport_user' in params:
            query_params['jcr:content/transportUser'] = params['jcrcontenttransport_user']
        if 'jcrcontenttransport_password' in params:
            query_params['jcr:content/transportPassword'] = params['jcrcontenttransport_password']
        ...
        if 'jcrcontentreverse_replication' in params:
            query_params['jcr:content/reverseReplication'] = params['jcrcontentreverse_replication']
