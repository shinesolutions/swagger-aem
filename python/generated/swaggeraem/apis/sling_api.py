...
class SlingApi(object):
    ...
    def post_config_apache_felix_jetty_based_http_service_with_http_info(self, runmode, **kwargs):
        ...
        return self.api_client.call_api('/apps/system/config.{runmode}/org.apache.felix.http', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def post_config_apache_sling_dav_ex_servlet_with_http_info(self, runmode, **kwargs):
        ...
        return self.api_client.call_api('/apps/system/config.{runmode}/org.apache.sling.jcr.davex.impl.servlets.SlingDavExServlet', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def post_config_apache_sling_get_servlet_with_http_info(self, runmode, **kwargs):
        ...
        return self.api_client.call_api('/apps/system/config.{runmode}/org.apache.sling.servlets.get.DefaultGetServlet', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def post_config_apache_sling_referrer_filter_with_http_info(self, runmode, **kwargs):
        ...
        return self.api_client.call_api('/apps/system/config.{runmode}/org.apache.sling.security.impl.ReferrerFilter', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
