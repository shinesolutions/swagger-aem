...
class TruststoreItems(object):
    ...
    def __init__(self, alias=None, entry_type=None, subject=None, issuer=None, not_before=None, not_after=None, serial_number=None):
        """
        TruststoreItems - a model defined in Swagger
        """
