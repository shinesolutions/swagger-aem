...
public class SlingApi {
    ...
    private com.squareup.okhttp.Call getAgentsCall(String runmode, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/etc/replication/agents.{runmode}.-1.json".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "runmode" + "\\}", apiClient.escapeString(runmode.toString()));
    ...
    private com.squareup.okhttp.Call postAgentCall(String runmode, String name, String jcrprimaryType, String jcrcontentcqname, String jcrcontentjcrtitle, String jcrcontentjcrdescription, String jcrcontentslingresourceType, String jcrcontenttransportUri, String jcrcontenttransportUser, String jcrcontenttransportPassword, String jcrcontentlogLevel, Boolean jcrcontentnoVersioning, List<String> jcrcontentprotocolHTTPHeaders, String jcrcontentprotocolHTTPHeadersTypeHint, String jcrcontentprotocolHTTPMethod, String jcrcontentretryDelay, String jcrcontentserializationType, String jcrcontentjcrmixinTypes, Boolean jcrcontenttriggerReceive, Boolean jcrcontenttriggerSpecific, String jcrcontentcqtemplate, Boolean jcrcontentenabled, Boolean jcrcontentreverseReplication, String operation, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "jcr:content/reverseReplication", jcrcontentreverseReplication));
        if (operation != null)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postAgent(String runmode, String name, String jcrprimaryType, String jcrcontentcqname, String jcrcontentjcrtitle, String jcrcontentjcrdescription, String jcrcontentslingresourceType, String jcrcontenttransportUri, String jcrcontenttransportUser, String jcrcontenttransportPassword, String jcrcontentlogLevel, Boolean jcrcontentnoVersioning, List<String> jcrcontentprotocolHTTPHeaders, String jcrcontentprotocolHTTPHeadersTypeHint, String jcrcontentprotocolHTTPMethod, String jcrcontentretryDelay, String jcrcontentserializationType, String jcrcontentjcrmixinTypes, Boolean jcrcontenttriggerReceive, Boolean jcrcontenttriggerSpecific, String jcrcontentcqtemplate, Boolean jcrcontentenabled, Boolean jcrcontentreverseReplication, String operation) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postAgentAsync(String runmode, String name, String jcrprimaryType, String jcrcontentcqname, String jcrcontentjcrtitle, String jcrcontentjcrdescription, String jcrcontentslingresourceType, String jcrcontenttransportUri, String jcrcontenttransportUser, String jcrcontenttransportPassword, String jcrcontentlogLevel, Boolean jcrcontentnoVersioning, List<String> jcrcontentprotocolHTTPHeaders, String jcrcontentprotocolHTTPHeadersTypeHint, String jcrcontentprotocolHTTPMethod, String jcrcontentretryDelay, String jcrcontentserializationType, String jcrcontentjcrmixinTypes, Boolean jcrcontenttriggerReceive, Boolean jcrcontenttriggerSpecific, String jcrcontentcqtemplate, Boolean jcrcontentenabled, Boolean jcrcontentreverseReplication, String operation, final ApiCallback<Void> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call postConfigApacheSlingDavExServletCall(String runmode, String alias, String aliasTypeHint, Boolean davCreateAbsoluteUri, String davCreateAbsoluteUriTypeHint, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/apps/system/config.{runmode}/org.apache.sling.jcr.davex.impl.servlets.SlingDavExServlet".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "runmode" + "\\}", apiClient.escapeString(runmode.toString()));
        ...
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "alias@TypeHint", aliasTypeHint));
        if (davCreateAbsoluteUri != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "dav.create-absolute-uri", davCreateAbsoluteUri));
        if (davCreateAbsoluteUriTypeHint != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "dav.create-absolute-uri@TypeHint", davCreateAbsoluteUriTypeHint));
    ...
    private com.squareup.okhttp.Call postConfigApacheSlingGetServletCall(String runmode, String jsonMaximumresults, String jsonMaximumresultsTypeHint, Boolean enableHtml, String enableHtmlTypeHint, Boolean enableTxt, String enableTxtTypeHint, Boolean enableXml, String enableXmlTypeHint, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/apps/system/config.{runmode}/org.apache.sling.servlets.get.DefaultGetServlet".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "runmode" + "\\}", apiClient.escapeString(runmode.toString()));

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        if (jsonMaximumresults != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "json.maximumresults", jsonMaximumresults));
        if (jsonMaximumresultsTypeHint != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "json.maximumresults@TypeHint", jsonMaximumresultsTypeHint));
        if (enableHtml != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "enable.html", enableHtml));
        if (enableHtmlTypeHint != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "enable.html@TypeHint", enableHtmlTypeHint));
        if (enableTxt != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "enable.txt", enableTxt));
        if (enableTxtTypeHint != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "enable.txt@TypeHint", enableTxtTypeHint));
        if (enableXml != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "enable.xml", enableXml));
        if (enableXmlTypeHint != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "enable.xml@TypeHint", enableXmlTypeHint));
    ...
    private com.squareup.okhttp.Call postConfigApacheSlingReferrerFilterCall(String runmode, Boolean allowEmpty, String allowEmptyTypeHint, String allowHosts, String allowHostsTypeHint, String allowHostsRegexp, String allowHostsRegexpTypeHint, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/apps/system/config.{runmode}/org.apache.sling.security.impl.ReferrerFilter".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "runmode" + "\\}", apiClient.escapeString(runmode.toString()));

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        if (allowEmpty != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "allow.empty", allowEmpty));
        if (allowEmptyTypeHint != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "allow.empty@TypeHint", allowEmptyTypeHint));
        if (allowHosts != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "allow.hosts", allowHosts));
        if (allowHostsTypeHint != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "allow.hosts@TypeHint", allowHostsTypeHint));
        if (allowHostsRegexp != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "allow.hosts.regexp", allowHostsRegexp));
        if (allowHostsRegexpTypeHint != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "allow.hosts.regexp@TypeHint", allowHostsRegexpTypeHint));
